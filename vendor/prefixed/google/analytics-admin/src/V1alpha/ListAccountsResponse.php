 ...
 *
 * Generated from protobuf message <code>google.analytics.admin.v1alpha.ListAccountsResponse</code>
 */
class ListAccountsResponse extends \Matomo\Dependencies\GoogleAnalyticsImporter\Google\Protobuf\Internal\Message
{
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Matomo\Dependencies\GoogleAnalyticsImporter\Google\Protobuf\Internal\GPBType::MESSAGE, \Matomo\Dependencies\GoogleAnalyticsImporter\Google\Analytics\Admin\V1alpha\Account::class);
        $this->accounts = $arr;
        return $this;
    }
    /**
