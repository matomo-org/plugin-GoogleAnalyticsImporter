...
class_alias(\Google\Analytics\Admin\V1alpha\AttributionSettings\ReportingAttributionModel::class, \Google\Analytics\Admin\V1alpha\AttributionSettings_ReportingAttributionModel::class);
