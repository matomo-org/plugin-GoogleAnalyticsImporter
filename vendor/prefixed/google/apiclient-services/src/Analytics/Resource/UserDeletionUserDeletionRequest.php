...
class_alias(UserDeletionUserDeletionRequest::class, 'Matomo\\Dependencies\\GoogleAnalyticsImporter\\Google_Service_Analytics_Resource_UserDeletionUserDeletionRequest');
