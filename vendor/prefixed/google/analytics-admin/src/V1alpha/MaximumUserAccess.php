...
class MaximumUserAccess
{
    ...
    private static $valueToName = [self::MAXIMUM_USER_ACCESS_UNSPECIFIED => 'MAXIMUM_USER_ACCESS_UNSPECIFIED', self::NO_ACCESS => 'NO_ACCESS', self::READ_AND_ANALYZE => 'READ_AND_ANALYZE', self::EDITOR_WITHOUT_LINK_MANAGEMENT => 'EDITOR_WITHOUT_LINK_MANAGEMENT', self::EDITOR_INCLUDING_LINK_MANAGEMENT => 'EDITOR_INCLUDING_LINK_MANAGEMENT'];
