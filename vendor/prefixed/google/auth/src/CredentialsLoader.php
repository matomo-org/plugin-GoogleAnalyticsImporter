...
use Matomo\Dependencies\GoogleAnalyticsImporter\Google\Auth\Credentials\ExternalAccountAuthorizedUserCredentials;
...
abstract class CredentialsLoader implements GetUniverseDomainInterface, FetchAuthTokenInterface, UpdateMetadataInterface
{
    ...
    public static function makeCredentials($scope, array $jsonKey, $defaultScope = null, bool $enableRegionalAccessBoundary = \false)
    {
        ...
        if ($jsonKey['type'] == 'service_account') {
            ...
            return new ServiceAccountCredentials($scope, $jsonKey, null, null, $enableRegionalAccessBoundary);
        }
        ...
        if ($jsonKey['type'] == 'impersonated_service_account') {
            return new ImpersonatedServiceAccountCredentials($scope, $jsonKey, null, $defaultScope, $enableRegionalAccessBoundary);
        }
     ...
     * @return mixed
     */
    private static function getEnv(string $env)
    {
