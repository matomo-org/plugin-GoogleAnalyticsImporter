...
namespace Matomo\Dependencies\GoogleAnalyticsImporter\Google\Analytics\Admin\V1alpha\ExpandedDataSetFilter;
...
class StringFilter extends \Matomo\Dependencies\GoogleAnalyticsImporter\Google\Protobuf\Internal\Message
{
    ...
    {
        GPBUtil::checkEnum($var, \Matomo\Dependencies\GoogleAnalyticsImporter\Google\Analytics\Admin\V1alpha\ExpandedDataSetFilter\StringFilter\MatchType::class);
        $this->match_type = $var;
        return $this;
    }
    /**
...
class_alias(StringFilter::class, \Matomo\Dependencies\GoogleAnalyticsImporter\Google\Analytics\Admin\V1alpha\ExpandedDataSetFilter_StringFilter::class);
