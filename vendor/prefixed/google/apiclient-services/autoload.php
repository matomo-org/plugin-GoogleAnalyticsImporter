...
if (\file_exists(__DIR__ . '/../apiclient/src/Google/Client.php') && !\class_exists('Matomo\\Dependencies\\GoogleAnalyticsImporter\\Google_Client', \false)) {
    ...
    if (\defined('Google_Client::LIBVER') && \version_compare(\Matomo\Dependencies\GoogleAnalyticsImporter\Google_Client::LIBVER, '2.7.2', '<=')) {
        $servicesClassMap = ['Matomo\\Dependencies\\GoogleAnalyticsImporter\\Google\\Client' => 'Google_Client', 'Matomo\\Dependencies\\GoogleAnalyticsImporter\\Google\\Service' => 'Google_Service', 'Matomo\\Dependencies\\GoogleAnalyticsImporter\\Google\\Service\\Resource' => 'Google_Service_Resource', 'Matomo\\Dependencies\\GoogleAnalyticsImporter\\Google\\Model' => 'Google_Model', 'Matomo\\Dependencies\\GoogleAnalyticsImporter\\Google\\Collection' => 'Google_Collection'];
