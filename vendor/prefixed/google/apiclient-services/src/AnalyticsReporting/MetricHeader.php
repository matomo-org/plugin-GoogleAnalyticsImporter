...
class MetricHeader extends \Matomo\Dependencies\GoogleAnalyticsImporter\Google\Collection
{
    protected $collection_key = 'pivotHeaders';
    protected $metricHeaderEntriesType = \Matomo\Dependencies\GoogleAnalyticsImporter\Google\Service\AnalyticsReporting\MetricHeaderEntry::class;
    protected $metricHeaderEntriesDataType = 'array';
    protected $pivotHeadersType = \Matomo\Dependencies\GoogleAnalyticsImporter\Google\Service\AnalyticsReporting\PivotHeader::class;
...
\class_alias(\Matomo\Dependencies\GoogleAnalyticsImporter\Google\Service\AnalyticsReporting\MetricHeader::class, 'Matomo\\Dependencies\\GoogleAnalyticsImporter\\Google_Service_AnalyticsReporting_MetricHeader');
