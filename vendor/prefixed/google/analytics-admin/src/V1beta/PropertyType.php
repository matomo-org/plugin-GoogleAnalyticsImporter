...
class PropertyType
{
    ...
    private static $valueToName = [self::PROPERTY_TYPE_UNSPECIFIED => 'PROPERTY_TYPE_UNSPECIFIED', self::PROPERTY_TYPE_ORDINARY => 'PROPERTY_TYPE_ORDINARY', self::PROPERTY_TYPE_SUBPROPERTY => 'PROPERTY_TYPE_SUBPROPERTY', self::PROPERTY_TYPE_ROLLUP => 'PROPERTY_TYPE_ROLLUP'];
