...
use Matomo\Dependencies\GoogleAnalyticsImporter\GuzzleHttp\Handler\CurlHandler;
use Matomo\Dependencies\GoogleAnalyticsImporter\GuzzleHttp\Handler\CurlMultiHandler;
...
use Matomo\Dependencies\GoogleAnalyticsImporter\GuzzleHttp\Handler\Proxy;
use Matomo\Dependencies\GoogleAnalyticsImporter\GuzzleHttp\Handler\StreamHandler;
...
final class Utils
{
    ...
    {
        \Matomo\Dependencies\GoogleAnalyticsImporter\trigger_deprecation('guzzlehttp/guzzle', '7.12', '%s() is deprecated and will be removed in 8.0. Use get_debug_type() instead.', __METHOD__);
    ...
    {
        \Matomo\Dependencies\GoogleAnalyticsImporter\trigger_deprecation('guzzlehttp/guzzle', '7.1', '%s() is deprecated and will be removed in 8.0. This method is not needed in PHP 5.6+.', __METHOD__);
        static $cached = null;
        static $cafiles = [
...
EOT
    ...
    {
        \Matomo\Dependencies\GoogleAnalyticsImporter\trigger_deprecation('guzzlehttp/guzzle', '7.15', '%s() is deprecated and will be removed in 8.0. Use PHP\'s json_decode() instead.', __METHOD__);
        if ($depth < 1) {
    ...
    {
        \Matomo\Dependencies\GoogleAnalyticsImporter\trigger_deprecation('guzzlehttp/guzzle', '7.15', '%s() is deprecated and will be removed in 8.0. Use PHP\'s json_encode() instead.', __METHOD__);
    ...
    public static function normalizeIdnConversionOption($value) : ?int
    {
        ...
        if (\is_string($value) && \is_numeric($value) || \is_float($value) && \is_finite($value)) {
            \Matomo\Dependencies\GoogleAnalyticsImporter\trigger_deprecation('guzzlehttp/guzzle', '7.11', 'Passing %s as the "idn_conversion" request option is deprecated; guzzlehttp/guzzle 8.0 will reject values that are not true, false, null, or an integer IDNA_* bitmask.', \get_debug_type($value));
            return (int) $value;
        }
