...
class AnyBase extends \Google\Protobuf\Internal\Message
{
    ...
    public function pack($msg)
    {
        ...
        $this->type_url = \Google\Protobuf\Internal\GPBUtil::TYPE_URL_PREFIX . $fully_qualifed_name;
    }
    /**
    ...
    public function is($klass)
    {
        ...
        $fully_qualifed_name = $desc->getFullName();
        $type_url = \Google\Protobuf\Internal\GPBUtil::TYPE_URL_PREFIX . $fully_qualifed_name;
