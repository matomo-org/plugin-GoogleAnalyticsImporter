...
class_alias(\Google\Analytics\Admin\V1alpha\AudienceDimensionOrMetricFilter\StringFilter::class, \Google\Analytics\Admin\V1alpha\AudienceDimensionOrMetricFilter_StringFilter::class);
