...
class PivotHeader extends \Matomo\Dependencies\GoogleAnalyticsImporter\Google\Collection
{
    ...
    protected $pivotHeaderEntriesType = \Google\Service\AnalyticsReporting\PivotHeaderEntry::class;
...
class_alias(\Google\Service\AnalyticsReporting\PivotHeader::class, 'Matomo\\Dependencies\\GoogleAnalyticsImporter\\Google_Service_AnalyticsReporting_PivotHeader');
