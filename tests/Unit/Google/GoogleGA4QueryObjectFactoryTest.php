...
class GoogleGA4QueryObjectFactoryTest extends TestCase
{
    ...
    public function test_make_createsProperRequest()
    {
        ...
        $options = [
            'dimensions' => ['someDim', 'someOtherDim'],
        ];
...
EOF;
    ...
    public function test_make_handlesOrderbyCorrectly()
    {
        ...
        $options = [
            'dimensions' => ['someDim', 'someOtherDim'],
            'orderBys' => [
                ['field' => 'someDim', 'order' => 'descENding'],
                ['field' => 'somemetric', 'order' => 'ascending'],
            ],
        ];
...
EOF;
    ...
    public function test_make_handlesShortOrderByCorrectly()
    {
        ...
        $options = [
            'dimensions' => ['someDim', 'someOtherDim'],
            'orderBys' => [
                ['field' => 'someDim', 'order' => 'desc'],
                ['field' => 'somemetric', 'order' => 'ASC'],
            ],
        ];
...
EOF;
    ...
    public function getTestDataForGetOrderByMetric()
    {
        return [
            ...
            [
                ['metric1', 'uniqueScreenviews'],
                [
                    'orderBys' => [
                        ['field' => 'uniqueScreenviews'],
                        ['field' => 'somedim1'],
                    ],
                ],
                'uniqueScreenviews',
            ...
            [
                ['sessions', 'uniquePageviews'],
                [],
                'sessions',
            ],
            [
                ['screenPageViews', 'alskdjf'],
                [],
                'screenPageViews',
            ],
            [
