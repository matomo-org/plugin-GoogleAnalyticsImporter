...
abstract class PHP extends Engine
{
    ...
    protected static function testJITOnWindows()
    {
        ...
        if (strtoupper(substr(\PHP_OS, 0, 3)) === 'WIN' && function_exists('opcache_get_status') && \PHP_VERSION_ID < 80213 && !defined('Matomo\\Dependencies\\GoogleAnalyticsImporter\\PHPSECLIB_ALLOW_JIT')) {
