...
class_alias(\Google\Analytics\Admin\V1alpha\AudienceDimensionOrMetricFilter\NumericValue::class, \Google\Analytics\Admin\V1alpha\AudienceDimensionOrMetricFilter_NumericValue::class);
