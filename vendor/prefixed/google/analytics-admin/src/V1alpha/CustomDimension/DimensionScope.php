...
namespace Matomo\Dependencies\GoogleAnalyticsImporter\Google\Analytics\Admin\V1alpha\CustomDimension;
...
class DimensionScope
{
     ...
     */
    const USER = 2;
    private static $valueToName = [self::DIMENSION_SCOPE_UNSPECIFIED => 'DIMENSION_SCOPE_UNSPECIFIED', self::EVENT => 'EVENT', self::USER => 'USER'];
...
\class_alias(\Matomo\Dependencies\GoogleAnalyticsImporter\Google\Analytics\Admin\V1alpha\CustomDimension\DimensionScope::class, \Matomo\Dependencies\GoogleAnalyticsImporter\Google\Analytics\Admin\V1alpha\CustomDimension_DimensionScope::class);
