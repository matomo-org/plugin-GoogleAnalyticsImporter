 ...
 *
 * Protobuf type <code>google.analytics.admin.v1alpha.ServiceLevel</code>
 */
class ServiceLevel
{
    /**
    ...
    private static $valueToName = [self::SERVICE_LEVEL_UNSPECIFIED => 'SERVICE_LEVEL_UNSPECIFIED', self::GOOGLE_ANALYTICS_STANDARD => 'GOOGLE_ANALYTICS_STANDARD', self::GOOGLE_ANALYTICS_360 => 'GOOGLE_ANALYTICS_360'];
