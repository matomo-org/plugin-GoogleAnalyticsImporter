...
class ImportTest extends SystemTestCase
{
    ...
    private static $ACTION_METRICS = ['nb_visits', 'nb_hits', 'sum_time_spent', 'exit_nb_visits', 'entry_nb_visits', 'entry_nb_actions', 'entry_sum_visit_length', 'entry_bounce_count', 'avg_bandwidth', 'avg_time_on_page', 'bounce_rate', 'exit_rate', 'avg_time_generation', 'nb_hits_with_time_generation', 'sum_daily_entry_nb_uniq_visitors', 'sum_daily_exit_nb_uniq_visitors', 'sum_daily_nb_uniq_visitors'];
    ...
    private static $SITESEARCH_METRICS = ['nb_visits', 'nb_hits', 'sum_time_spent', 'sum_daily_nb_uniq_visitors', 'nb_pages_per_search', 'avg_bandwidth', 'avg_time_on_page', 'bounce_rate', 'exit_rate'];
    /**
