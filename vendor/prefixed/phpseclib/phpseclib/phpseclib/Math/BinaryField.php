...
use Matomo\Dependencies\GoogleAnalyticsImporter\phpseclib3\Math\BinaryField\Integer;
use Matomo\Dependencies\GoogleAnalyticsImporter\phpseclib3\Math\Common\FiniteField;
/**
 * Binary Finite Fields
 *
 * @package Math
...
class BinaryField extends FiniteField
{
    ...
    public function __construct(...$indices)
    {
        ...
        $this->randomMax = new \Matomo\Dependencies\GoogleAnalyticsImporter\phpseclib3\Math\BigInteger($modulo, 2);
    }
    /**
    ...
    {
        return new Integer($this->instanceID, $num instanceof \Matomo\Dependencies\GoogleAnalyticsImporter\phpseclib3\Math\BigInteger ? $num->toBytes() : $num);
    }
    /**
    ...
    public function randomInteger()
    {
        static $one;
        if (!isset($one)) {
            $one = new \Matomo\Dependencies\GoogleAnalyticsImporter\phpseclib3\Math\BigInteger(1);
        }
        return new Integer($this->instanceID, \Matomo\Dependencies\GoogleAnalyticsImporter\phpseclib3\Math\BigInteger::randomRange($one, $this->randomMax)->toBytes());
    }
    /**
