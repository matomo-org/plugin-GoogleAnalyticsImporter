...
class_alias(\Google\Service\Analytics\Resource\ManagementGoals::class, 'Matomo\\Dependencies\\GoogleAnalyticsImporter\\Google_Service_Analytics_Resource_ManagementGoals');
