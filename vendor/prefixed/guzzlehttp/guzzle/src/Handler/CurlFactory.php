...
use Matomo\Dependencies\GoogleAnalyticsImporter\GuzzleHttp\Psr7\LazyOpenStream;
 ...
 * @final
 */
class CurlFactory implements \Matomo\Dependencies\GoogleAnalyticsImporter\GuzzleHttp\Handler\CurlFactoryInterface
{
    ...
    public function create(RequestInterface $request, array $options) : \Matomo\Dependencies\GoogleAnalyticsImporter\GuzzleHttp\Handler\EasyHandle
    {
        ...
        $easy = new \Matomo\Dependencies\GoogleAnalyticsImporter\GuzzleHttp\Handler\EasyHandle();
     ...
     */
    public static function finish(callable $handler, \Matomo\Dependencies\GoogleAnalyticsImporter\GuzzleHttp\Handler\EasyHandle $easy, \Matomo\Dependencies\GoogleAnalyticsImporter\GuzzleHttp\Handler\CurlFactoryInterface $factory) : PromiseInterface
    {
    ...
    private static function invokeStats(\Matomo\Dependencies\GoogleAnalyticsImporter\GuzzleHttp\Handler\EasyHandle $easy) : void
    {
     ...
     * @param callable(RequestInterface, array): PromiseInterface $handler
     */
    private static function finishError(callable $handler, \Matomo\Dependencies\GoogleAnalyticsImporter\GuzzleHttp\Handler\EasyHandle $easy, \Matomo\Dependencies\GoogleAnalyticsImporter\GuzzleHttp\Handler\CurlFactoryInterface $factory) : PromiseInterface
    {
    ...
    private static function createRejection(\Matomo\Dependencies\GoogleAnalyticsImporter\GuzzleHttp\Handler\EasyHandle $easy, array $ctx) : PromiseInterface
    {
     ...
     */
    private function getDefaultConf(\Matomo\Dependencies\GoogleAnalyticsImporter\GuzzleHttp\Handler\EasyHandle $easy) : array
    {
    ...
    private function applyMethod(\Matomo\Dependencies\GoogleAnalyticsImporter\GuzzleHttp\Handler\EasyHandle $easy, array &$conf) : void
    {
    ...
    private function applyHeaders(\Matomo\Dependencies\GoogleAnalyticsImporter\GuzzleHttp\Handler\EasyHandle $easy, array &$conf) : void
    {
    ...
    private function applyHandlerOptions(\Matomo\Dependencies\GoogleAnalyticsImporter\GuzzleHttp\Handler\EasyHandle $easy, array &$conf) : void
    {
        ...
        if (!isset($options['sink'])) {
            ...
            $options['sink'] = \Matomo\Dependencies\GoogleAnalyticsImporter\GuzzleHttp\Psr7\Utils::tryFopen('php://temp', 'w+');
        }
        $sink = $options['sink'];
        if (!\is_string($sink)) {
            $sink = \Matomo\Dependencies\GoogleAnalyticsImporter\GuzzleHttp\Psr7\Utils::streamFor($sink);
     ...
     * @param callable(RequestInterface, array): PromiseInterface $handler
     */
    private static function retryFailedRewind(callable $handler, \Matomo\Dependencies\GoogleAnalyticsImporter\GuzzleHttp\Handler\EasyHandle $easy, array $ctx) : PromiseInterface
    {
        try {
    ...
    private function createHeaderFn(\Matomo\Dependencies\GoogleAnalyticsImporter\GuzzleHttp\Handler\EasyHandle $easy) : callable
    {
