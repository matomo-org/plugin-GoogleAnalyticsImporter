...
\class_alias(\Matomo\Dependencies\GoogleAnalyticsImporter\Google\Api\Expr\V1alpha1\Type\FunctionType::class, \Matomo\Dependencies\GoogleAnalyticsImporter\Google\Api\Expr\V1alpha1\Type_FunctionType::class);
