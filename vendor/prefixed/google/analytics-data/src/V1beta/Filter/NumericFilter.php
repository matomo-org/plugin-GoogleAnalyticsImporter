...
namespace Matomo\Dependencies\GoogleAnalyticsImporter\Google\Analytics\Data\V1beta\Filter;
...
class NumericFilter extends \Matomo\Dependencies\GoogleAnalyticsImporter\Google\Protobuf\Internal\Message
{
    ...
    {
        GPBUtil::checkEnum($var, \Matomo\Dependencies\GoogleAnalyticsImporter\Google\Analytics\Data\V1beta\Filter\NumericFilter\Operation::class);
        $this->operation = $var;
        return $this;
    }
    /**
    ...
    {
        GPBUtil::checkMessage($var, \Matomo\Dependencies\GoogleAnalyticsImporter\Google\Analytics\Data\V1beta\NumericValue::class);
        $this->value = $var;
        return $this;
    }
}
