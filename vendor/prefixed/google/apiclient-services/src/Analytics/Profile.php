...
class Profile extends \Matomo\Dependencies\GoogleAnalyticsImporter\Google\Model
{
    public $accountId;
    public $botFilteringEnabled;
    protected $childLinkType = \Matomo\Dependencies\GoogleAnalyticsImporter\Google\Service\Analytics\ProfileChildLink::class;
    ...
    public $kind;
    public $name;
    protected $parentLinkType = \Matomo\Dependencies\GoogleAnalyticsImporter\Google\Service\Analytics\ProfileParentLink::class;
    protected $parentLinkDataType = '';
    protected $permissionsType = \Matomo\Dependencies\GoogleAnalyticsImporter\Google\Service\Analytics\ProfilePermissions::class;
     ...
     */
    public function setChildLink(\Matomo\Dependencies\GoogleAnalyticsImporter\Google\Service\Analytics\ProfileChildLink $childLink)
    {
     ...
     */
    public function setParentLink(\Matomo\Dependencies\GoogleAnalyticsImporter\Google\Service\Analytics\ProfileParentLink $parentLink)
    {
     ...
     */
    public function setPermissions(\Matomo\Dependencies\GoogleAnalyticsImporter\Google\Service\Analytics\ProfilePermissions $permissions)
    {
...
\class_alias(\Matomo\Dependencies\GoogleAnalyticsImporter\Google\Service\Analytics\Profile::class, 'Matomo\\Dependencies\\GoogleAnalyticsImporter\\Google_Service_Analytics_Profile');
