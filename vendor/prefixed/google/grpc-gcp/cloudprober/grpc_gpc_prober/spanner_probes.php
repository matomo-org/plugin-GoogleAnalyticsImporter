...
{
    global $_DATABASE;
    $createSessionRequest = new \Matomo\Dependencies\GoogleAnalyticsImporter\Google\Cloud\Spanner\V1\CreateSessionRequest();
    ...
    #Get Session
    $getSessionRequest = new \Matomo\Dependencies\GoogleAnalyticsImporter\Google\Cloud\Spanner\V1\GetSessionRequest();
    ...
    #List session
    $listSessionsRequest = new \Matomo\Dependencies\GoogleAnalyticsImporter\Google\Cloud\Spanner\V1\ListSessionsRequest();
    ...
    #Delete session
    $deleteSessionRequest = new \Matomo\Dependencies\GoogleAnalyticsImporter\Google\Cloud\Spanner\V1\DeleteSessionRequest();
...
function executeSql($client, &$metrics)
{
    ...
    $time_start = microtime_float();
    $executeSqlRequest = new \Matomo\Dependencies\GoogleAnalyticsImporter\Google\Cloud\Spanner\V1\ExecuteSqlRequest();
...
function read($client, &$metrics)
{
    ...
    # Probing Read call
    $time_start = microtime_float();
    $readRequest = new \Matomo\Dependencies\GoogleAnalyticsImporter\Google\Cloud\Spanner\V1\ReadRequest();
    $readRequest->setSession($session->getName());
    $readRequest->setTable('users');
    $readRequest->setColumns(['username', 'firstname', 'lastname']);
    $keyset = new \Matomo\Dependencies\GoogleAnalyticsImporter\Google\Cloud\Spanner\V1\KeySet();
    $keyset->setAll(\Matomo\Dependencies\GoogleAnalyticsImporter\True);
...
function transaction($client, &$metrics)
{
    ...
    hardAssertIfStatusOk($status);
    hardAssert($session !== null, 'Call completed with a null response');
    $txn_options = new \Matomo\Dependencies\GoogleAnalyticsImporter\Google\Cloud\Spanner\V1\TransactionOptions();
    $rw = new \Matomo\Dependencies\GoogleAnalyticsImporter\Google\Cloud\Spanner\V1\TransactionOptions\ReadWrite();
    $txn_options->setReadWrite($rw);
    $txn_request = new \Matomo\Dependencies\GoogleAnalyticsImporter\Google\Cloud\Spanner\V1\BeginTransactionRequest();
    ...
    # Probing Commit Call
    $commit_request = new \Matomo\Dependencies\GoogleAnalyticsImporter\Google\Cloud\Spanner\V1\CommitRequest();
    ...
    list($txn, $status) = $client->BeginTransaction($txn_request)->wait();
    $rollback_request = new \Matomo\Dependencies\GoogleAnalyticsImporter\Google\Cloud\Spanner\V1\RollbackRequest();
...
function partition($client, &$metrics)
{
    ...
    hardAssert($session !== null, 'Call completed with a null response');
    $txn_options = new \Matomo\Dependencies\GoogleAnalyticsImporter\Google\Cloud\Spanner\V1\TransactionOptions();
    $ro = new \Matomo\Dependencies\GoogleAnalyticsImporter\Google\Cloud\Spanner\V1\TransactionOptions\ReadOnly();
    $txn_options->setReadOnly($ro);
    $txn_selector = new \Matomo\Dependencies\GoogleAnalyticsImporter\Google\Cloud\Spanner\V1\TransactionSelector();
    $txn_selector->setBegin($txn_options);
    #Probing PartitionQuery call
    $ptn_query_request = new \Matomo\Dependencies\GoogleAnalyticsImporter\Google\Cloud\Spanner\V1\PartitionQueryRequest();
    ...
    $ptn_read_request = new \Matomo\Dependencies\GoogleAnalyticsImporter\Google\Cloud\Spanner\V1\PartitionReadRequest();
