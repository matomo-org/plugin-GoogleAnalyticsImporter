 ...
 */
use Matomo\Dependencies\GoogleAnalyticsImporter\google\appengine\api\app_identity\AppIdentityService;
...
class AppIdentityCredentials extends CredentialsLoader implements SignBlobInterface, ProjectIdProviderInterface
{
    ...
    {
        if (!self::onAppEngine() || !class_exists('Matomo\\Dependencies\\GoogleAnalyticsImporter\\google\\appengine\\api\\app_identity\\AppIdentityService')) {
