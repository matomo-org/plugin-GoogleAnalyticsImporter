...
use Matomo\Dependencies\GoogleAnalyticsImporter\Google\Analytics\Admin\V1alpha\AndroidAppDataStream;
...
use Matomo\Dependencies\GoogleAnalyticsImporter\Google\Analytics\Admin\V1alpha\CreateWebDataStreamRequest;
...
use Matomo\Dependencies\GoogleAnalyticsImporter\Google\Analytics\Admin\V1alpha\DeleteAndroidAppDataStreamRequest;
...
use Matomo\Dependencies\GoogleAnalyticsImporter\Google\Analytics\Admin\V1alpha\DeleteIosAppDataStreamRequest;
...
use Matomo\Dependencies\GoogleAnalyticsImporter\Google\Analytics\Admin\V1alpha\DeleteWebDataStreamRequest;
...
use Matomo\Dependencies\GoogleAnalyticsImporter\Google\Analytics\Admin\V1alpha\GetAndroidAppDataStreamRequest;
...
use Matomo\Dependencies\GoogleAnalyticsImporter\Google\Analytics\Admin\V1alpha\GetIosAppDataStreamRequest;
...
use Matomo\Dependencies\GoogleAnalyticsImporter\Google\Analytics\Admin\V1alpha\GetWebDataStreamRequest;
...
use Matomo\Dependencies\GoogleAnalyticsImporter\Google\Analytics\Admin\V1alpha\IosAppDataStream;
...
use Matomo\Dependencies\GoogleAnalyticsImporter\Google\Analytics\Admin\V1alpha\ListAndroidAppDataStreamsRequest;
use Matomo\Dependencies\GoogleAnalyticsImporter\Google\Analytics\Admin\V1alpha\ListAndroidAppDataStreamsResponse;
...
use Matomo\Dependencies\GoogleAnalyticsImporter\Google\Analytics\Admin\V1alpha\ListIosAppDataStreamsRequest;
use Matomo\Dependencies\GoogleAnalyticsImporter\Google\Analytics\Admin\V1alpha\ListIosAppDataStreamsResponse;
...
use Matomo\Dependencies\GoogleAnalyticsImporter\Google\Analytics\Admin\V1alpha\ListWebDataStreamsRequest;
use Matomo\Dependencies\GoogleAnalyticsImporter\Google\Analytics\Admin\V1alpha\ListWebDataStreamsResponse;
...
use Matomo\Dependencies\GoogleAnalyticsImporter\Google\Analytics\Admin\V1alpha\UpdateAndroidAppDataStreamRequest;
...
use Matomo\Dependencies\GoogleAnalyticsImporter\Google\Analytics\Admin\V1alpha\UpdateIosAppDataStreamRequest;
...
use Matomo\Dependencies\GoogleAnalyticsImporter\Google\Analytics\Admin\V1alpha\UpdateWebDataStreamRequest;
use Matomo\Dependencies\GoogleAnalyticsImporter\Google\Analytics\Admin\V1alpha\UserLink;
use Matomo\Dependencies\GoogleAnalyticsImporter\Google\Analytics\Admin\V1alpha\WebDataStream;
...
class AnalyticsAdminServiceGapicClient
{
    ...
    {
        return self::getAndroidAppDataStreamNameTemplate()->render(['property' => $property, 'android_app_data_stream' => $androidAppDataStream]);
    }
    /**
     * Formats a string containing the fully-qualified path to represent a
    ...
    {
        return self::getCustomDimensionNameTemplate()->render(['property' => $property]);
    }
    /**
     * Formats a string containing the fully-qualified path to represent a
    ...
    {
        return self::getCustomMetricNameTemplate()->render(['property' => $property]);
    }
    /**
     * Formats a string containing the fully-qualified path to represent a
    ...
    {
        return self::getGlobalSiteTagNameTemplate()->render(['property' => $property]);
    }
    /**
     * Formats a string containing the fully-qualified path to represent a
    ...
    {
        return self::getIosAppDataStreamNameTemplate()->render(['property' => $property, 'ios_app_data_stream' => $iosAppDataStream]);
    }
    /**
     * Formats a string containing the fully-qualified path to represent a
    ...
    {
        return self::getMeasurementProtocolSecretNameTemplate()->render(['property' => $property, 'web_data_stream' => $webDataStream, 'measurement_protocol_secret' => $measurementProtocolSecret]);
    }
    /**
    ...
    {
        return self::getWebDataStreamNameTemplate()->render(['property' => $property, 'web_data_stream' => $webDataStream]);
    }
    /**
