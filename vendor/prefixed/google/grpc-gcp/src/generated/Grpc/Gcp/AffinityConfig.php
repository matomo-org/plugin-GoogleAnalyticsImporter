 ...
 */
class AffinityConfig extends \Matomo\Dependencies\GoogleAnalyticsImporter\Google\Protobuf\Internal\Message
{
    /**
    ...
    {
        GPBUtil::checkEnum($var, \Matomo\Dependencies\GoogleAnalyticsImporter\Grpc\Gcp\AffinityConfig_Command::class);
        $this->command = $var;
        return $this;
    }
    /**
