 ...
 * @access  public
 */
abstract class PHP extends \Matomo\Dependencies\GoogleAnalyticsImporter\phpseclib3\Math\BigInteger\Engines\Engine
{
    /**#@+
     * Array constants
     *
     ...
     */
    protected function divideHelper(\Matomo\Dependencies\GoogleAnalyticsImporter\phpseclib3\Math\BigInteger\Engines\PHP $y)
    {
        if (\count($y->value) == 1) {
     ...
     * @return static
     */
    protected function normalize(\Matomo\Dependencies\GoogleAnalyticsImporter\phpseclib3\Math\BigInteger\Engines\PHP $result)
    {
     ...
     * @return PHP
     */
    protected function powModInner(\Matomo\Dependencies\GoogleAnalyticsImporter\phpseclib3\Math\BigInteger\Engines\PHP $e, \Matomo\Dependencies\GoogleAnalyticsImporter\phpseclib3\Math\BigInteger\Engines\PHP $n)
    {
        try {
            $class = static::$modexpEngine[static::class];
            return $class::powModHelper($this, $e, $n, static::class);
        } catch (\Exception $err) {
            return \Matomo\Dependencies\GoogleAnalyticsImporter\phpseclib3\Math\BigInteger\Engines\PHP\DefaultEngine::powModHelper($this, $e, $n, static::class);
        }
    }
    /**
     * Performs squaring
     ...
     * @see self::isPrime()
     */
    public static function scan1divide(\Matomo\Dependencies\GoogleAnalyticsImporter\phpseclib3\Math\BigInteger\Engines\PHP $r)
    {
        $r_value =& $r->value;
     ...
     * @return PHP
     */
    protected function powHelper(\Matomo\Dependencies\GoogleAnalyticsImporter\phpseclib3\Math\BigInteger\Engines\PHP $n)
    {
