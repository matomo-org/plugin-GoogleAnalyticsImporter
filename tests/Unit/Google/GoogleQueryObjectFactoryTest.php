...
class GoogleQueryObjectFactoryTest extends TestCase
{
    ...
    public function test_make_createsProperRequest()
    {
        ...
        $options = [
            'dimensions' => ['ga:someDim', 'ga:someOtherDim'],
        ];
...
END;
    ...
    public function test_make_handlesOrderbyCorrectly()
    {
        ...
        $options = [
            'dimensions' => ['ga:someDim', 'ga:someOtherDim'],
            'orderBys' => [
                ['field' => 'ga:someDim', 'order' => 'descENding'],
                ['field' => 'ga:somemetric', 'order' => 'ascending'],
            ],
        ];
...
END;
    ...
    public function test_make_handlesShortOrderByCorrectly()
    {
        ...
        $options = [
            'dimensions' => ['ga:someDim', 'ga:someOtherDim'],
            'orderBys' => [
                ['field' => 'ga:someDim', 'order' => 'desc'],
                ['field' => 'ga:somemetric', 'order' => 'ASC'],
            ],
        ];
...
END;
    ...
    public function getTestDataForGetOrderByMetric()
    {
        return [
            ...
            [
                ['ga:metric1', 'ga:uniqueScreenviews'],
                [
                    'orderBys' => [
                        ['field' => 'ga:uniqueScreenviews'],
                        ['field' => 'somedim1'],
                    ],
                ],
            ...
            [
                ['ga:metric1', 'ga:screenviews'],
                [
                    'orderBys' => [
                        ['field' => 'ga:pageviews'],
                        ['field' => 'ga:screenviews'],
                    ],
                ],
                'ga:screenviews',
            ],
            [
                ['ga:metric1', 'ga:sessions'],
                [
                    'orderBys' => [
                        ['field' => 'ga:sessions'],
                        ['field' => 'ga:sessions'],
            ...
            [
                ['ga:metric1', 'ga:goalCompletionsAll'],
                [
                    'orderBys' => [
                        ['field' => 'ga:pageviews'],
                        ['field' => 'ga:screenviews'],
            ...
            [
                ['ga:sessions', 'ga:uniquePageviews'],
                [],
                'ga:uniquePageviews',
            ],
            [
                ['ga:uniqueScreenviews', 'ga:alskdjf'],
                [],
                'ga:uniqueScreenviews',
            ],
            [
