...
class ReportData extends \Matomo\Dependencies\GoogleAnalyticsImporter\Google\Collection
{
    protected $collection_key = 'totals';
    public $dataLastRefreshed;
    public $emptyReason;
    public $isDataGolden;
    protected $maximumsType = \Matomo\Dependencies\GoogleAnalyticsImporter\Google\Service\AnalyticsReporting\DateRangeValues::class;
    protected $maximumsDataType = 'array';
    protected $minimumsType = \Matomo\Dependencies\GoogleAnalyticsImporter\Google\Service\AnalyticsReporting\DateRangeValues::class;
    protected $minimumsDataType = 'array';
    public $rowCount;
    protected $rowsType = \Matomo\Dependencies\GoogleAnalyticsImporter\Google\Service\AnalyticsReporting\ReportRow::class;
    protected $rowsDataType = 'array';
    public $samplesReadCounts;
    public $samplingSpaceSizes;
    protected $totalsType = \Matomo\Dependencies\GoogleAnalyticsImporter\Google\Service\AnalyticsReporting\DateRangeValues::class;
...
\class_alias(\Matomo\Dependencies\GoogleAnalyticsImporter\Google\Service\AnalyticsReporting\ReportData::class, 'Matomo\\Dependencies\\GoogleAnalyticsImporter\\Google_Service_AnalyticsReporting_ReportData');
