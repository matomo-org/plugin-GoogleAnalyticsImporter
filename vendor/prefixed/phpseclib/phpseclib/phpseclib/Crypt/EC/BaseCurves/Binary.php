...
use Matomo\Dependencies\GoogleAnalyticsImporter\phpseclib3\Math\BinaryField\Integer as BinaryInteger;
/**
 * Curves over y^2 + x*y = x^3 + a*x^2 + b
 *
 * @package Binary
 ...
 * @access  public
 */
class Binary extends \Matomo\Dependencies\GoogleAnalyticsImporter\phpseclib3\Crypt\EC\BaseCurves\Base
{
    /**
