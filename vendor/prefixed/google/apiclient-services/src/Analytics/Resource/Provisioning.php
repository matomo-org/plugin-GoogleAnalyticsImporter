...
class_alias(\Google\Service\Analytics\Resource\Provisioning::class, 'Matomo\\Dependencies\\GoogleAnalyticsImporter\\Google_Service_Analytics_Resource_Provisioning');
