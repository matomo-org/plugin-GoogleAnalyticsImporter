...
use Matomo\Dependencies\GoogleAnalyticsImporter\phpseclib3\Crypt\Common\Formats\Keys\PuTTY as Progenitor;
...
{
    use \Matomo\Dependencies\GoogleAnalyticsImporter\phpseclib3\Crypt\EC\Formats\Keys\Common;
    /**
     * Public Handler
     *
     * @var string
     * @access private
     */
    const PUBLIC_HANDLER = 'Matomo\\Dependencies\\GoogleAnalyticsImporter\\phpseclib3\\Crypt\\EC\\Formats\\Keys\\OpenSSH';
    /**
     * Supported Key Types
     *
     * @var array
    ...
    public static function load($key, $password = '')
    {
        ...
        $components = \Matomo\Dependencies\GoogleAnalyticsImporter\phpseclib3\Crypt\EC\Formats\Keys\OpenSSH::load($components['type'] . ' ' . $temp . ' ' . $components['comment']);
    ...
    public static function savePrivateKey(BigInteger $privateKey, BaseCurve $curve, array $publicKey, $password = \false, array $options = [])
    {
        ...
        $public = \explode(' ', \Matomo\Dependencies\GoogleAnalyticsImporter\phpseclib3\Crypt\EC\Formats\Keys\OpenSSH::savePublicKey($curve, $publicKey));
        $name = $public[0];
