...
use DomainException;
use Matomo\Dependencies\GoogleAnalyticsImporter\Google\Auth\Credentials\AppIdentityCredentials;
...
use Matomo\Dependencies\GoogleAnalyticsImporter\Google\Auth\Logging\StdOutLogger;
use Matomo\Dependencies\GoogleAnalyticsImporter\Google\Auth\Middleware\AuthTokenMiddleware;
use Matomo\Dependencies\GoogleAnalyticsImporter\Google\Auth\Middleware\ProxyAuthTokenMiddleware;
use Matomo\Dependencies\GoogleAnalyticsImporter\Google\Auth\Subscriber\AuthTokenSubscriber;
...
class ApplicationDefaultCredentials
{
     ...
     * @throws DomainException if no implementation can be obtained.
     */
    public static function getCredentials($scope = null, ?callable $httpHandler = null, ?array $cacheConfig = null, ?CacheItemPoolInterface $cache = null, $quotaProject = null, $defaultScope = null, ?string $universeDomain = null, $logger = null, bool $enableRegionalAccessBoundary = \false)
    {
        $creds = null;
        ...
        if (!is_null($jsonKey)) {
            ...
            $creds = new GCECredentials(null, $anyScope, null, $quotaProject, null, $universeDomain, $enableRegionalAccessBoundary);
        ...
        if (!is_null($jsonKey)) {
            ...
            switch ($jsonKey['type']) {
                ...
                case 'impersonated_service_account':
                    $creds = new ImpersonatedServiceAccountCredentials(null, $jsonKey, $targetAudience);
                    break;
     ...
     */
    public static function getDefaultLogger() : ?\Matomo\Dependencies\GoogleAnalyticsImporter\Psr\Log\LoggerInterface
    {
