 ...
 * @experimental
 */
namespace Matomo\Dependencies\GoogleAnalyticsImporter\Google\Analytics\Admin\V1alpha\Gapic;

use Matomo\Dependencies\GoogleAnalyticsImporter\Google\Analytics\Admin\V1alpha\AccessBinding;
use Matomo\Dependencies\GoogleAnalyticsImporter\Google\Analytics\Admin\V1alpha\AccessDateRange;
use Matomo\Dependencies\GoogleAnalyticsImporter\Google\Analytics\Admin\V1alpha\AccessDimension;
use Matomo\Dependencies\GoogleAnalyticsImporter\Google\Analytics\Admin\V1alpha\AccessFilterExpression;
use Matomo\Dependencies\GoogleAnalyticsImporter\Google\Analytics\Admin\V1alpha\AccessMetric;
use Matomo\Dependencies\GoogleAnalyticsImporter\Google\Analytics\Admin\V1alpha\AccessOrderBy;
use Matomo\Dependencies\GoogleAnalyticsImporter\Google\Analytics\Admin\V1alpha\Account;
use Matomo\Dependencies\GoogleAnalyticsImporter\Google\Analytics\Admin\V1alpha\AcknowledgeUserDataCollectionRequest;
use Matomo\Dependencies\GoogleAnalyticsImporter\Google\Analytics\Admin\V1alpha\AcknowledgeUserDataCollectionResponse;
use Matomo\Dependencies\GoogleAnalyticsImporter\Google\Analytics\Admin\V1alpha\ApproveDisplayVideo360AdvertiserLinkProposalRequest;
use Matomo\Dependencies\GoogleAnalyticsImporter\Google\Analytics\Admin\V1alpha\ApproveDisplayVideo360AdvertiserLinkProposalResponse;
use Matomo\Dependencies\GoogleAnalyticsImporter\Google\Analytics\Admin\V1alpha\ArchiveAudienceRequest;
use Matomo\Dependencies\GoogleAnalyticsImporter\Google\Analytics\Admin\V1alpha\ArchiveCustomDimensionRequest;
use Matomo\Dependencies\GoogleAnalyticsImporter\Google\Analytics\Admin\V1alpha\ArchiveCustomMetricRequest;
use Matomo\Dependencies\GoogleAnalyticsImporter\Google\Analytics\Admin\V1alpha\AttributionSettings;
use Matomo\Dependencies\GoogleAnalyticsImporter\Google\Analytics\Admin\V1alpha\Audience;
use Matomo\Dependencies\GoogleAnalyticsImporter\Google\Analytics\Admin\V1alpha\AuditUserLinksRequest;
use Matomo\Dependencies\GoogleAnalyticsImporter\Google\Analytics\Admin\V1alpha\AuditUserLinksResponse;
use Matomo\Dependencies\GoogleAnalyticsImporter\Google\Analytics\Admin\V1alpha\BatchCreateAccessBindingsRequest;
use Matomo\Dependencies\GoogleAnalyticsImporter\Google\Analytics\Admin\V1alpha\BatchCreateAccessBindingsResponse;
use Matomo\Dependencies\GoogleAnalyticsImporter\Google\Analytics\Admin\V1alpha\BatchCreateUserLinksRequest;
use Matomo\Dependencies\GoogleAnalyticsImporter\Google\Analytics\Admin\V1alpha\BatchCreateUserLinksResponse;
use Matomo\Dependencies\GoogleAnalyticsImporter\Google\Analytics\Admin\V1alpha\BatchDeleteAccessBindingsRequest;
...
use Matomo\Dependencies\GoogleAnalyticsImporter\Google\Analytics\Admin\V1alpha\BatchGetAccessBindingsResponse;
use Matomo\Dependencies\GoogleAnalyticsImporter\Google\Analytics\Admin\V1alpha\BatchGetUserLinksRequest;
use Matomo\Dependencies\GoogleAnalyticsImporter\Google\Analytics\Admin\V1alpha\BatchGetUserLinksResponse;
use Matomo\Dependencies\GoogleAnalyticsImporter\Google\Analytics\Admin\V1alpha\BatchUpdateAccessBindingsRequest;
use Matomo\Dependencies\GoogleAnalyticsImporter\Google\Analytics\Admin\V1alpha\BatchUpdateAccessBindingsResponse;
use Matomo\Dependencies\GoogleAnalyticsImporter\Google\Analytics\Admin\V1alpha\BatchUpdateUserLinksRequest;
use Matomo\Dependencies\GoogleAnalyticsImporter\Google\Analytics\Admin\V1alpha\BatchUpdateUserLinksResponse;
use Matomo\Dependencies\GoogleAnalyticsImporter\Google\Analytics\Admin\V1alpha\BigQueryLink;
use Matomo\Dependencies\GoogleAnalyticsImporter\Google\Analytics\Admin\V1alpha\CancelDisplayVideo360AdvertiserLinkProposalRequest;
use Matomo\Dependencies\GoogleAnalyticsImporter\Google\Analytics\Admin\V1alpha\ConversionEvent;
use Matomo\Dependencies\GoogleAnalyticsImporter\Google\Analytics\Admin\V1alpha\CreateAccessBindingRequest;
use Matomo\Dependencies\GoogleAnalyticsImporter\Google\Analytics\Admin\V1alpha\CreateAudienceRequest;
use Matomo\Dependencies\GoogleAnalyticsImporter\Google\Analytics\Admin\V1alpha\CreateConversionEventRequest;
use Matomo\Dependencies\GoogleAnalyticsImporter\Google\Analytics\Admin\V1alpha\CreateCustomDimensionRequest;
use Matomo\Dependencies\GoogleAnalyticsImporter\Google\Analytics\Admin\V1alpha\CreateCustomMetricRequest;
use Matomo\Dependencies\GoogleAnalyticsImporter\Google\Analytics\Admin\V1alpha\CreateDataStreamRequest;
use Matomo\Dependencies\GoogleAnalyticsImporter\Google\Analytics\Admin\V1alpha\CreateDisplayVideo360AdvertiserLinkProposalRequest;
use Matomo\Dependencies\GoogleAnalyticsImporter\Google\Analytics\Admin\V1alpha\CreateDisplayVideo360AdvertiserLinkRequest;
use Matomo\Dependencies\GoogleAnalyticsImporter\Google\Analytics\Admin\V1alpha\CreateExpandedDataSetRequest;
use Matomo\Dependencies\GoogleAnalyticsImporter\Google\Analytics\Admin\V1alpha\CreateFirebaseLinkRequest;
use Matomo\Dependencies\GoogleAnalyticsImporter\Google\Analytics\Admin\V1alpha\CreateGoogleAdsLinkRequest;
use Matomo\Dependencies\GoogleAnalyticsImporter\Google\Analytics\Admin\V1alpha\CreateMeasurementProtocolSecretRequest;
use Matomo\Dependencies\GoogleAnalyticsImporter\Google\Analytics\Admin\V1alpha\CreatePropertyRequest;
use Matomo\Dependencies\GoogleAnalyticsImporter\Google\Analytics\Admin\V1alpha\CreateSearchAds360LinkRequest;
use Matomo\Dependencies\GoogleAnalyticsImporter\Google\Analytics\Admin\V1alpha\CreateUserLinkRequest;
use Matomo\Dependencies\GoogleAnalyticsImporter\Google\Analytics\Admin\V1alpha\CustomDimension;
use Matomo\Dependencies\GoogleAnalyticsImporter\Google\Analytics\Admin\V1alpha\CustomMetric;
use Matomo\Dependencies\GoogleAnalyticsImporter\Google\Analytics\Admin\V1alpha\DataRetentionSettings;
use Matomo\Dependencies\GoogleAnalyticsImporter\Google\Analytics\Admin\V1alpha\DataSharingSettings;
use Matomo\Dependencies\GoogleAnalyticsImporter\Google\Analytics\Admin\V1alpha\DataStream;
use Matomo\Dependencies\GoogleAnalyticsImporter\Google\Analytics\Admin\V1alpha\DeleteAccessBindingRequest;
use Matomo\Dependencies\GoogleAnalyticsImporter\Google\Analytics\Admin\V1alpha\DeleteAccountRequest;
use Matomo\Dependencies\GoogleAnalyticsImporter\Google\Analytics\Admin\V1alpha\DeleteConversionEventRequest;
use Matomo\Dependencies\GoogleAnalyticsImporter\Google\Analytics\Admin\V1alpha\DeleteDataStreamRequest;
use Matomo\Dependencies\GoogleAnalyticsImporter\Google\Analytics\Admin\V1alpha\DeleteDisplayVideo360AdvertiserLinkProposalRequest;
use Matomo\Dependencies\GoogleAnalyticsImporter\Google\Analytics\Admin\V1alpha\DeleteDisplayVideo360AdvertiserLinkRequest;
use Matomo\Dependencies\GoogleAnalyticsImporter\Google\Analytics\Admin\V1alpha\DeleteExpandedDataSetRequest;
use Matomo\Dependencies\GoogleAnalyticsImporter\Google\Analytics\Admin\V1alpha\DeleteFirebaseLinkRequest;
use Matomo\Dependencies\GoogleAnalyticsImporter\Google\Analytics\Admin\V1alpha\DeleteGoogleAdsLinkRequest;
use Matomo\Dependencies\GoogleAnalyticsImporter\Google\Analytics\Admin\V1alpha\DeleteMeasurementProtocolSecretRequest;
use Matomo\Dependencies\GoogleAnalyticsImporter\Google\Analytics\Admin\V1alpha\DeletePropertyRequest;
use Matomo\Dependencies\GoogleAnalyticsImporter\Google\Analytics\Admin\V1alpha\DeleteSearchAds360LinkRequest;
use Matomo\Dependencies\GoogleAnalyticsImporter\Google\Analytics\Admin\V1alpha\DeleteUserLinkRequest;
use Matomo\Dependencies\GoogleAnalyticsImporter\Google\Analytics\Admin\V1alpha\DisplayVideo360AdvertiserLink;
use Matomo\Dependencies\GoogleAnalyticsImporter\Google\Analytics\Admin\V1alpha\DisplayVideo360AdvertiserLinkProposal;
use Matomo\Dependencies\GoogleAnalyticsImporter\Google\Analytics\Admin\V1alpha\ExpandedDataSet;
use Matomo\Dependencies\GoogleAnalyticsImporter\Google\Analytics\Admin\V1alpha\FetchAutomatedGa4ConfigurationOptOutRequest;
use Matomo\Dependencies\GoogleAnalyticsImporter\Google\Analytics\Admin\V1alpha\FetchAutomatedGa4ConfigurationOptOutResponse;
use Matomo\Dependencies\GoogleAnalyticsImporter\Google\Analytics\Admin\V1alpha\FirebaseLink;
use Matomo\Dependencies\GoogleAnalyticsImporter\Google\Analytics\Admin\V1alpha\GetAccessBindingRequest;
use Matomo\Dependencies\GoogleAnalyticsImporter\Google\Analytics\Admin\V1alpha\GetAccountRequest;
use Matomo\Dependencies\GoogleAnalyticsImporter\Google\Analytics\Admin\V1alpha\GetAttributionSettingsRequest;
use Matomo\Dependencies\GoogleAnalyticsImporter\Google\Analytics\Admin\V1alpha\GetAudienceRequest;
use Matomo\Dependencies\GoogleAnalyticsImporter\Google\Analytics\Admin\V1alpha\GetBigQueryLinkRequest;
use Matomo\Dependencies\GoogleAnalyticsImporter\Google\Analytics\Admin\V1alpha\GetConversionEventRequest;
use Matomo\Dependencies\GoogleAnalyticsImporter\Google\Analytics\Admin\V1alpha\GetCustomDimensionRequest;
use Matomo\Dependencies\GoogleAnalyticsImporter\Google\Analytics\Admin\V1alpha\GetCustomMetricRequest;
use Matomo\Dependencies\GoogleAnalyticsImporter\Google\Analytics\Admin\V1alpha\GetDataRetentionSettingsRequest;
use Matomo\Dependencies\GoogleAnalyticsImporter\Google\Analytics\Admin\V1alpha\GetDataSharingSettingsRequest;
use Matomo\Dependencies\GoogleAnalyticsImporter\Google\Analytics\Admin\V1alpha\GetDataStreamRequest;
use Matomo\Dependencies\GoogleAnalyticsImporter\Google\Analytics\Admin\V1alpha\GetDisplayVideo360AdvertiserLinkProposalRequest;
use Matomo\Dependencies\GoogleAnalyticsImporter\Google\Analytics\Admin\V1alpha\GetDisplayVideo360AdvertiserLinkRequest;
use Matomo\Dependencies\GoogleAnalyticsImporter\Google\Analytics\Admin\V1alpha\GetExpandedDataSetRequest;
use Matomo\Dependencies\GoogleAnalyticsImporter\Google\Analytics\Admin\V1alpha\GetGlobalSiteTagRequest;
use Matomo\Dependencies\GoogleAnalyticsImporter\Google\Analytics\Admin\V1alpha\GetGoogleSignalsSettingsRequest;
use Matomo\Dependencies\GoogleAnalyticsImporter\Google\Analytics\Admin\V1alpha\GetMeasurementProtocolSecretRequest;
use Matomo\Dependencies\GoogleAnalyticsImporter\Google\Analytics\Admin\V1alpha\GetPropertyRequest;
use Matomo\Dependencies\GoogleAnalyticsImporter\Google\Analytics\Admin\V1alpha\GetSearchAds360LinkRequest;
use Matomo\Dependencies\GoogleAnalyticsImporter\Google\Analytics\Admin\V1alpha\GetUserLinkRequest;
use Matomo\Dependencies\GoogleAnalyticsImporter\Google\Analytics\Admin\V1alpha\GlobalSiteTag;
use Matomo\Dependencies\GoogleAnalyticsImporter\Google\Analytics\Admin\V1alpha\GoogleAdsLink;
use Matomo\Dependencies\GoogleAnalyticsImporter\Google\Analytics\Admin\V1alpha\GoogleSignalsSettings;
use Matomo\Dependencies\GoogleAnalyticsImporter\Google\Analytics\Admin\V1alpha\ListAccessBindingsRequest;
use Matomo\Dependencies\GoogleAnalyticsImporter\Google\Analytics\Admin\V1alpha\ListAccessBindingsResponse;
use Matomo\Dependencies\GoogleAnalyticsImporter\Google\Analytics\Admin\V1alpha\ListAccountSummariesRequest;
use Matomo\Dependencies\GoogleAnalyticsImporter\Google\Analytics\Admin\V1alpha\ListAccountSummariesResponse;
use Matomo\Dependencies\GoogleAnalyticsImporter\Google\Analytics\Admin\V1alpha\ListAccountsRequest;
use Matomo\Dependencies\GoogleAnalyticsImporter\Google\Analytics\Admin\V1alpha\ListAccountsResponse;
use Matomo\Dependencies\GoogleAnalyticsImporter\Google\Analytics\Admin\V1alpha\ListAudiencesRequest;
use Matomo\Dependencies\GoogleAnalyticsImporter\Google\Analytics\Admin\V1alpha\ListAudiencesResponse;
use Matomo\Dependencies\GoogleAnalyticsImporter\Google\Analytics\Admin\V1alpha\ListBigQueryLinksRequest;
use Matomo\Dependencies\GoogleAnalyticsImporter\Google\Analytics\Admin\V1alpha\ListBigQueryLinksResponse;
use Matomo\Dependencies\GoogleAnalyticsImporter\Google\Analytics\Admin\V1alpha\ListConversionEventsRequest;
use Matomo\Dependencies\GoogleAnalyticsImporter\Google\Analytics\Admin\V1alpha\ListConversionEventsResponse;
use Matomo\Dependencies\GoogleAnalyticsImporter\Google\Analytics\Admin\V1alpha\ListCustomDimensionsRequest;
use Matomo\Dependencies\GoogleAnalyticsImporter\Google\Analytics\Admin\V1alpha\ListCustomDimensionsResponse;
use Matomo\Dependencies\GoogleAnalyticsImporter\Google\Analytics\Admin\V1alpha\ListCustomMetricsRequest;
use Matomo\Dependencies\GoogleAnalyticsImporter\Google\Analytics\Admin\V1alpha\ListCustomMetricsResponse;
use Matomo\Dependencies\GoogleAnalyticsImporter\Google\Analytics\Admin\V1alpha\ListDataStreamsRequest;
use Matomo\Dependencies\GoogleAnalyticsImporter\Google\Analytics\Admin\V1alpha\ListDataStreamsResponse;
use Matomo\Dependencies\GoogleAnalyticsImporter\Google\Analytics\Admin\V1alpha\ListDisplayVideo360AdvertiserLinkProposalsRequest;
use Matomo\Dependencies\GoogleAnalyticsImporter\Google\Analytics\Admin\V1alpha\ListDisplayVideo360AdvertiserLinkProposalsResponse;
use Matomo\Dependencies\GoogleAnalyticsImporter\Google\Analytics\Admin\V1alpha\ListDisplayVideo360AdvertiserLinksRequest;
use Matomo\Dependencies\GoogleAnalyticsImporter\Google\Analytics\Admin\V1alpha\ListDisplayVideo360AdvertiserLinksResponse;
use Matomo\Dependencies\GoogleAnalyticsImporter\Google\Analytics\Admin\V1alpha\ListExpandedDataSetsRequest;
use Matomo\Dependencies\GoogleAnalyticsImporter\Google\Analytics\Admin\V1alpha\ListExpandedDataSetsResponse;
use Matomo\Dependencies\GoogleAnalyticsImporter\Google\Analytics\Admin\V1alpha\ListFirebaseLinksRequest;
use Matomo\Dependencies\GoogleAnalyticsImporter\Google\Analytics\Admin\V1alpha\ListFirebaseLinksResponse;
use Matomo\Dependencies\GoogleAnalyticsImporter\Google\Analytics\Admin\V1alpha\ListGoogleAdsLinksRequest;
use Matomo\Dependencies\GoogleAnalyticsImporter\Google\Analytics\Admin\V1alpha\ListGoogleAdsLinksResponse;
use Matomo\Dependencies\GoogleAnalyticsImporter\Google\Analytics\Admin\V1alpha\ListMeasurementProtocolSecretsRequest;
use Matomo\Dependencies\GoogleAnalyticsImporter\Google\Analytics\Admin\V1alpha\ListMeasurementProtocolSecretsResponse;
use Matomo\Dependencies\GoogleAnalyticsImporter\Google\Analytics\Admin\V1alpha\ListPropertiesRequest;
use Matomo\Dependencies\GoogleAnalyticsImporter\Google\Analytics\Admin\V1alpha\ListPropertiesResponse;
use Matomo\Dependencies\GoogleAnalyticsImporter\Google\Analytics\Admin\V1alpha\ListSearchAds360LinksRequest;
use Matomo\Dependencies\GoogleAnalyticsImporter\Google\Analytics\Admin\V1alpha\ListSearchAds360LinksResponse;
use Matomo\Dependencies\GoogleAnalyticsImporter\Google\Analytics\Admin\V1alpha\ListUserLinksRequest;
use Matomo\Dependencies\GoogleAnalyticsImporter\Google\Analytics\Admin\V1alpha\ListUserLinksResponse;
use Matomo\Dependencies\GoogleAnalyticsImporter\Google\Analytics\Admin\V1alpha\MeasurementProtocolSecret;
use Matomo\Dependencies\GoogleAnalyticsImporter\Google\Analytics\Admin\V1alpha\Property;
use Matomo\Dependencies\GoogleAnalyticsImporter\Google\Analytics\Admin\V1alpha\ProvisionAccountTicketRequest;
use Matomo\Dependencies\GoogleAnalyticsImporter\Google\Analytics\Admin\V1alpha\ProvisionAccountTicketResponse;
use Matomo\Dependencies\GoogleAnalyticsImporter\Google\Analytics\Admin\V1alpha\RunAccessReportRequest;
use Matomo\Dependencies\GoogleAnalyticsImporter\Google\Analytics\Admin\V1alpha\RunAccessReportResponse;
use Matomo\Dependencies\GoogleAnalyticsImporter\Google\Analytics\Admin\V1alpha\SearchAds360Link;
use Matomo\Dependencies\GoogleAnalyticsImporter\Google\Analytics\Admin\V1alpha\SearchChangeHistoryEventsRequest;
use Matomo\Dependencies\GoogleAnalyticsImporter\Google\Analytics\Admin\V1alpha\SearchChangeHistoryEventsResponse;
use Matomo\Dependencies\GoogleAnalyticsImporter\Google\Analytics\Admin\V1alpha\SetAutomatedGa4ConfigurationOptOutRequest;
use Matomo\Dependencies\GoogleAnalyticsImporter\Google\Analytics\Admin\V1alpha\SetAutomatedGa4ConfigurationOptOutResponse;
use Matomo\Dependencies\GoogleAnalyticsImporter\Google\Analytics\Admin\V1alpha\UpdateAccessBindingRequest;
use Matomo\Dependencies\GoogleAnalyticsImporter\Google\Analytics\Admin\V1alpha\UpdateAccountRequest;
use Matomo\Dependencies\GoogleAnalyticsImporter\Google\Analytics\Admin\V1alpha\UpdateAttributionSettingsRequest;
use Matomo\Dependencies\GoogleAnalyticsImporter\Google\Analytics\Admin\V1alpha\UpdateAudienceRequest;
use Matomo\Dependencies\GoogleAnalyticsImporter\Google\Analytics\Admin\V1alpha\UpdateCustomDimensionRequest;
use Matomo\Dependencies\GoogleAnalyticsImporter\Google\Analytics\Admin\V1alpha\UpdateCustomMetricRequest;
use Matomo\Dependencies\GoogleAnalyticsImporter\Google\Analytics\Admin\V1alpha\UpdateDataRetentionSettingsRequest;
use Matomo\Dependencies\GoogleAnalyticsImporter\Google\Analytics\Admin\V1alpha\UpdateDataStreamRequest;
use Matomo\Dependencies\GoogleAnalyticsImporter\Google\Analytics\Admin\V1alpha\UpdateDisplayVideo360AdvertiserLinkRequest;
use Matomo\Dependencies\GoogleAnalyticsImporter\Google\Analytics\Admin\V1alpha\UpdateExpandedDataSetRequest;
use Matomo\Dependencies\GoogleAnalyticsImporter\Google\Analytics\Admin\V1alpha\UpdateGoogleAdsLinkRequest;
use Matomo\Dependencies\GoogleAnalyticsImporter\Google\Analytics\Admin\V1alpha\UpdateGoogleSignalsSettingsRequest;
...
use Matomo\Dependencies\GoogleAnalyticsImporter\Google\Analytics\Admin\V1alpha\UpdateSearchAds360LinkRequest;
use Matomo\Dependencies\GoogleAnalyticsImporter\Google\Analytics\Admin\V1alpha\UpdateUserLinkRequest;
use Matomo\Dependencies\GoogleAnalyticsImporter\Google\Analytics\Admin\V1alpha\UserLink;
...
use Matomo\Dependencies\GoogleAnalyticsImporter\Google\ApiCore\PathTemplate;
...
use Matomo\Dependencies\GoogleAnalyticsImporter\Google\Protobuf\Timestamp;
/**
...
class AnalyticsAdminServiceGapicClient
{
    ...
    public static $serviceScopes = ['https://www.googleapis.com/auth/analytics.edit', 'https://www.googleapis.com/auth/analytics.manage.users', 'https://www.googleapis.com/auth/analytics.manage.users.readonly', 'https://www.googleapis.com/auth/analytics.readonly'];
    ...
    {
        return self::getAccessBindingNameTemplate()->render(['account' => $account, 'access_binding' => $accessBinding]);
    }
    /**
    ...
    {
        return self::getAccountNameTemplate()->render(['account' => $account]);
    }
    /**
     * Formats a string containing the fully-qualified path to represent a
    ...
    {
        return self::getAccountAccessBindingNameTemplate()->render(['account' => $account, 'access_binding' => $accessBinding]);
    }
    /**
     * Formats a string containing the fully-qualified path to represent a
    ...
    {
        return self::getAccountUserLinkNameTemplate()->render(['account' => $account, 'user_link' => $userLink]);
    }
    /**
     * Formats a string containing the fully-qualified path to represent a
    ...
    {
        return self::getAttributionSettingsNameTemplate()->render(['property' => $property]);
    }
    /**
    ...
    {
        return self::getAudienceNameTemplate()->render(['property' => $property, 'audience' => $audience]);
    }
    /**
     * Formats a string containing the fully-qualified path to represent a
    ...
    {
        return self::getBigQueryLinkNameTemplate()->render(['property' => $property, 'bigquery_link' => $bigqueryLink]);
    }
    /**
     * Formats a string containing the fully-qualified path to represent a
    ...
    {
        return self::getConversionEventNameTemplate()->render(['property' => $property, 'conversion_event' => $conversionEvent]);
    }
    /**
     * Formats a string containing the fully-qualified path to represent a
    ...
    {
        return self::getCustomDimensionNameTemplate()->render(['property' => $property, 'custom_dimension' => $customDimension]);
    }
    /**
     * Formats a string containing the fully-qualified path to represent a
    ...
    {
        return self::getCustomMetricNameTemplate()->render(['property' => $property, 'custom_metric' => $customMetric]);
    }
    /**
     * Formats a string containing the fully-qualified path to represent a
    ...
    {
        return self::getDataRetentionSettingsNameTemplate()->render(['property' => $property]);
    }
    /**
     * Formats a string containing the fully-qualified path to represent a
    ...
    {
        return self::getDataSharingSettingsNameTemplate()->render(['account' => $account]);
    }
    /**
    ...
    {
        return self::getDataStreamNameTemplate()->render(['property' => $property, 'data_stream' => $dataStream]);
    }
    /**
     * Formats a string containing the fully-qualified path to represent a
    ...
    {
        return self::getDisplayVideo360AdvertiserLinkNameTemplate()->render(['property' => $property, 'display_video_360_advertiser_link' => $displayVideo360AdvertiserLink]);
    }
    /**
     * Formats a string containing the fully-qualified path to represent a
    ...
    {
        return self::getDisplayVideo360AdvertiserLinkProposalNameTemplate()->render(['property' => $property, 'display_video_360_advertiser_link_proposal' => $displayVideo360AdvertiserLinkProposal]);
    }
    /**
     * Formats a string containing the fully-qualified path to represent a
    ...
    {
        return self::getExpandedDataSetNameTemplate()->render(['property' => $property, 'expanded_data_set' => $expandedDataSet]);
    }
    /**
     * Formats a string containing the fully-qualified path to represent a
    ...
    {
        return self::getFirebaseLinkNameTemplate()->render(['property' => $property, 'firebase_link' => $firebaseLink]);
    }
    /**
     * Formats a string containing the fully-qualified path to represent a
    ...
    {
        return self::getGlobalSiteTagNameTemplate()->render(['property' => $property, 'data_stream' => $dataStream]);
    }
    /**
     * Formats a string containing the fully-qualified path to represent a
    ...
    {
        return self::getGoogleAdsLinkNameTemplate()->render(['property' => $property, 'google_ads_link' => $googleAdsLink]);
    }
    /**
     * Formats a string containing the fully-qualified path to represent a
    ...
    {
        return self::getGoogleSignalsSettingsNameTemplate()->render(['property' => $property]);
    }
    /**
     * Formats a string containing the fully-qualified path to represent a
    ...
    {
        return self::getMeasurementProtocolSecretNameTemplate()->render(['property' => $property, 'data_stream' => $dataStream, 'measurement_protocol_secret' => $measurementProtocolSecret]);
    }
    /**
    ...
    {
        return self::getPropertyAccessBindingNameTemplate()->render(['property' => $property, 'access_binding' => $accessBinding]);
    }
    /**
     * Formats a string containing the fully-qualified path to represent a
    ...
    {
        return self::getPropertyUserLinkNameTemplate()->render(['property' => $property, 'user_link' => $userLink]);
    }
    /**
     * Formats a string containing the fully-qualified path to represent a
    ...
    {
        return self::getSearchAds360LinkNameTemplate()->render(['property' => $property, 'search_ads_360_link' => $searchAds360Link]);
    }
    /**
    ...
    {
        return self::getUserLinkNameTemplate()->render(['account' => $account, 'user_link' => $userLink]);
    }
    /**
