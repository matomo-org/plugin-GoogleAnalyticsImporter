 ...
 */
abstract class CredentialsLoader implements \Matomo\Dependencies\GoogleAnalyticsImporter\Google\Auth\FetchAuthTokenInterface, \Matomo\Dependencies\GoogleAnalyticsImporter\Google\Auth\UpdateMetadataInterface
{
     ...
     */
    public static function makeHttpClient(\Matomo\Dependencies\GoogleAnalyticsImporter\Google\Auth\FetchAuthTokenInterface $fetcher, array $httpClientOptions = [], callable $httpHandler = null, callable $tokenCallback = null)
    {
        $middleware = new \Matomo\Dependencies\GoogleAnalyticsImporter\Google\Auth\Middleware\AuthTokenMiddleware($fetcher, $httpHandler, $tokenCallback);
        $stack = \Matomo\Dependencies\GoogleAnalyticsImporter\GuzzleHttp\HandlerStack::create();
        $stack->push($middleware);
        return new \Matomo\Dependencies\GoogleAnalyticsImporter\GuzzleHttp\Client(['handler' => $stack, 'auth' => 'google_auth'] + $httpClientOptions);
    }
    /**
