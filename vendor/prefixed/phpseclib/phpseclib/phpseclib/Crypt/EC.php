 ...
 */
namespace Matomo\Dependencies\GoogleAnalyticsImporter\phpseclib3\Crypt;

use Matomo\Dependencies\GoogleAnalyticsImporter\phpseclib3\Crypt\Common\AsymmetricKey;
use Matomo\Dependencies\GoogleAnalyticsImporter\phpseclib3\Crypt\EC\BaseCurves\Montgomery as MontgomeryCurve;
use Matomo\Dependencies\GoogleAnalyticsImporter\phpseclib3\Crypt\EC\BaseCurves\TwistedEdwards as TwistedEdwardsCurve;
use Matomo\Dependencies\GoogleAnalyticsImporter\phpseclib3\Crypt\EC\Curves\Curve25519;
use Matomo\Dependencies\GoogleAnalyticsImporter\phpseclib3\Crypt\EC\Curves\Curve448;
use Matomo\Dependencies\GoogleAnalyticsImporter\phpseclib3\Crypt\EC\Curves\Ed25519;
use Matomo\Dependencies\GoogleAnalyticsImporter\phpseclib3\Crypt\EC\Curves\Ed448;
use Matomo\Dependencies\GoogleAnalyticsImporter\phpseclib3\Crypt\EC\Formats\Keys\PKCS1;
use Matomo\Dependencies\GoogleAnalyticsImporter\phpseclib3\Crypt\EC\Formats\Keys\PKCS8;
use Matomo\Dependencies\GoogleAnalyticsImporter\phpseclib3\Crypt\EC\Parameters;
use Matomo\Dependencies\GoogleAnalyticsImporter\phpseclib3\Crypt\EC\PrivateKey;
use Matomo\Dependencies\GoogleAnalyticsImporter\phpseclib3\Crypt\EC\PublicKey;
...
use Matomo\Dependencies\GoogleAnalyticsImporter\phpseclib3\Exception\UnsupportedOperationException;
use Matomo\Dependencies\GoogleAnalyticsImporter\phpseclib3\File\ASN1;
use Matomo\Dependencies\GoogleAnalyticsImporter\phpseclib3\File\ASN1\Maps\ECParameters;
        ...
        switch ($curveName) {
            case 'Ed25519':
                $providers = [
                    ...
                    'OpenSSL' => defined('Matomo\\Dependencies\\GoogleAnalyticsImporter\\OPENSSL_KEYTYPE_ED25519'),
                ];
                break;
            case 'Ed448':
                // OPENSSL_KEYTYPE_ED448 introduced in PHP 8.4.0
                $providers = ['OpenSSL' => defined('Matomo\\Dependencies\\GoogleAnalyticsImporter\\OPENSSL_KEYTYPE_ED448')];
                break;
            case 'Curve25519':
                $providers = [
