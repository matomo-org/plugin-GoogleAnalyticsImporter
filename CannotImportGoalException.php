...
{
    /**
     * @var \Matomo\Dependencies\GoogleAnalyticsImporter\Google\Service\Analytics\Goal
     */
    private $gaGoal;
    private $reason;
    /**
     * CannotImportGoalException constructor.
     * @param \Matomo\Dependencies\GoogleAnalyticsImporter\Google\Service\Analytics\Goal $gaGoal
     * @param string $string
     */
