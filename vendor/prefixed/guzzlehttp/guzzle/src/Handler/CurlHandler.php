...
class CurlHandler
{
    ...
    {
        $this->factory = $options['handle_factory'] ?? new \Matomo\Dependencies\GoogleAnalyticsImporter\GuzzleHttp\Handler\CurlFactory(3);
    }
    public function __invoke(RequestInterface $request, array $options) : PromiseInterface
    {
        ...
        return \Matomo\Dependencies\GoogleAnalyticsImporter\GuzzleHttp\Handler\CurlFactory::finish($this, $easy, $this->factory);
    }
}
