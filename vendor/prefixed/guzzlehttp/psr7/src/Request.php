...
{
    use \Matomo\Dependencies\GoogleAnalyticsImporter\GuzzleHttp\Psr7\MessageTrait;
    /** @var string */
    private $method;
    /** @var string|null */
    ...
    public function __construct(string $method, $uri, array $headers = [], $body = null, string $version = '1.1')
    {
        ...
        if (!$uri instanceof UriInterface) {
            $uri = new \Matomo\Dependencies\GoogleAnalyticsImporter\GuzzleHttp\Psr7\Uri($uri);
        }
        ...
        if ($body !== '' && $body !== null) {
            $this->stream = \Matomo\Dependencies\GoogleAnalyticsImporter\GuzzleHttp\Psr7\Utils::streamFor($body);
        }
    }
