 ...
 */
class AnyBase extends \Matomo\Dependencies\GoogleAnalyticsImporter\Google\Protobuf\Internal\Message
{
    ...
    public function unpack()
    {
        ...
        $url_prifix_len = \strlen(\Matomo\Dependencies\GoogleAnalyticsImporter\Google\Protobuf\Internal\GPBUtil::TYPE_URL_PREFIX);
        if (\substr($this->type_url, 0, $url_prifix_len) != \Matomo\Dependencies\GoogleAnalyticsImporter\Google\Protobuf\Internal\GPBUtil::TYPE_URL_PREFIX) {
    ...
    {
        if (!$msg instanceof \Matomo\Dependencies\GoogleAnalyticsImporter\Google\Protobuf\Internal\Message) {
        ...
        $this->type_url = \Matomo\Dependencies\GoogleAnalyticsImporter\Google\Protobuf\Internal\GPBUtil::TYPE_URL_PREFIX . $fully_qualifed_name;
    }
    /**
    ...
    public function is($klass)
    {
        ...
        $fully_qualifed_name = $desc->getFullName();
        $type_url = \Matomo\Dependencies\GoogleAnalyticsImporter\Google\Protobuf\Internal\GPBUtil::TYPE_URL_PREFIX . $fully_qualifed_name;
