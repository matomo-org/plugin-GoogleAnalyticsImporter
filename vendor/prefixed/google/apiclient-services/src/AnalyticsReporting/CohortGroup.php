...
class CohortGroup extends \Matomo\Dependencies\GoogleAnalyticsImporter\Google\Collection
{
    ...
    protected $cohortsType = \Google\Service\AnalyticsReporting\Cohort::class;
...
class_alias(\Google\Service\AnalyticsReporting\CohortGroup::class, 'Matomo\\Dependencies\\GoogleAnalyticsImporter\\Google_Service_AnalyticsReporting_CohortGroup');
