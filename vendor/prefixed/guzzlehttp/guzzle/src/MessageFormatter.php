 ...
 * @final
 */
class MessageFormatter implements \Matomo\Dependencies\GoogleAnalyticsImporter\GuzzleHttp\MessageFormatterInterface
{
    /**
    ...
    public function format(RequestInterface $request, ?ResponseInterface $response = null, ?\Throwable $error = null) : string
    {
        ...
        return \preg_replace_callback('/{\\s*([A-Za-z_\\-\\.0-9]+)\\s*}/', function (array $matches) use($request, $response, $error, &$cache) {
            ...
            switch ($matches[1]) {
                case 'request':
                    $result = \Matomo\Dependencies\GoogleAnalyticsImporter\GuzzleHttp\Psr7\Message::toString($request);
                    break;
                case 'response':
                    $result = $response ? \Matomo\Dependencies\GoogleAnalyticsImporter\GuzzleHttp\Psr7\Message::toString($response) : '';
                    break;
                case 'req_headers':
