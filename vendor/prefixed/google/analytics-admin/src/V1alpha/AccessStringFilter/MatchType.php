...
namespace Matomo\Dependencies\GoogleAnalyticsImporter\Google\Analytics\Admin\V1alpha\AccessStringFilter;

use UnexpectedValueException;
/**
 * The match type of a string filter.
 *
 * Protobuf type <code>google.analytics.admin.v1alpha.AccessStringFilter.MatchType</code>
 */
class MatchType
{
    /**
...
class_alias(MatchType::class, \Matomo\Dependencies\GoogleAnalyticsImporter\Google\Analytics\Admin\V1alpha\AccessStringFilter_MatchType::class);
