...
class Exemplar extends \Google\Protobuf\Internal\Message
{
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Matomo\Dependencies\GoogleAnalyticsImporter\Google\Protobuf\Any::class);
        $this->attachments = $arr;
        return $this;
    }
}
// Adding a class alias for backwards compatibility with the previous class name.
class_alias(\Google\Api\Distribution\Exemplar::class, \Google\Api\Distribution_Exemplar::class);
