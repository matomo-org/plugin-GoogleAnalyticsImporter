...
class GetReportsRequest extends \Matomo\Dependencies\GoogleAnalyticsImporter\Google\Collection
{
    ...
    protected $reportRequestsType = \Google\Service\AnalyticsReporting\ReportRequest::class;
...
class_alias(\Google\Service\AnalyticsReporting\GetReportsRequest::class, 'Matomo\\Dependencies\\GoogleAnalyticsImporter\\Google_Service_AnalyticsReporting_GetReportsRequest');
