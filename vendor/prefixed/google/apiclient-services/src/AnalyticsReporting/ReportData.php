...
class ReportData extends \Matomo\Dependencies\GoogleAnalyticsImporter\Google\Collection
{
    ...
    public $emptyReason;
    public $isDataGolden;
    protected $maximumsType = \Google\Service\AnalyticsReporting\DateRangeValues::class;
    protected $maximumsDataType = 'array';
    protected $minimumsType = \Google\Service\AnalyticsReporting\DateRangeValues::class;
    protected $minimumsDataType = 'array';
    public $rowCount;
    protected $rowsType = \Google\Service\AnalyticsReporting\ReportRow::class;
    protected $rowsDataType = 'array';
    public $samplesReadCounts;
    public $samplingSpaceSizes;
    protected $totalsType = \Google\Service\AnalyticsReporting\DateRangeValues::class;
...
class_alias(\Google\Service\AnalyticsReporting\ReportData::class, 'Matomo\\Dependencies\\GoogleAnalyticsImporter\\Google_Service_AnalyticsReporting_ReportData');
