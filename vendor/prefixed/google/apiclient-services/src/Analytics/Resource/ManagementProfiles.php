...
class_alias(\Google\Service\Analytics\Resource\ManagementProfiles::class, 'Matomo\\Dependencies\\GoogleAnalyticsImporter\\Google_Service_Analytics_Resource_ManagementProfiles');
