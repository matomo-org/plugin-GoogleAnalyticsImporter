...
class_alias(\Google\Analytics\Admin\V1alpha\AccessOrderBy\DimensionOrderBy\OrderType::class, \Google\Analytics\Admin\V1alpha\AccessOrderBy_DimensionOrderBy_OrderType::class);
