 ...
 */
namespace Matomo\Dependencies\GoogleAnalyticsImporter\Google\Http;
...
use Matomo\Dependencies\GoogleAnalyticsImporter\Google\Task\Runner;
use Matomo\Dependencies\GoogleAnalyticsImporter\Google\Service\Exception as GoogleServiceException;
...
use Matomo\Dependencies\GoogleAnalyticsImporter\GuzzleHttp\Psr7\Response;
...
class REST
{
    ...
    public static function doExecute(ClientInterface $client, RequestInterface $request, $expectedClass = null)
    {
        try {
            ...
            if ($response instanceof \Matomo\Dependencies\GoogleAnalyticsImporter\GuzzleHttp\Message\ResponseInterface) {
