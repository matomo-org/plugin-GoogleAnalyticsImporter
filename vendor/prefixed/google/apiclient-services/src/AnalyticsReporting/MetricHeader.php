...
class MetricHeader extends \Matomo\Dependencies\GoogleAnalyticsImporter\Google\Collection
{
    ...
    protected $metricHeaderEntriesType = \Google\Service\AnalyticsReporting\MetricHeaderEntry::class;
    protected $metricHeaderEntriesDataType = 'array';
    protected $pivotHeadersType = \Google\Service\AnalyticsReporting\PivotHeader::class;
...
class_alias(\Google\Service\AnalyticsReporting\MetricHeader::class, 'Matomo\\Dependencies\\GoogleAnalyticsImporter\\Google_Service_AnalyticsReporting_MetricHeader');
