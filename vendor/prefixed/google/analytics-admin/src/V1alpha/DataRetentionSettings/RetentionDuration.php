...
namespace Matomo\Dependencies\GoogleAnalyticsImporter\Google\Analytics\Admin\V1alpha\DataRetentionSettings;
...
class RetentionDuration
{
    ...
    private static $valueToName = [self::RETENTION_DURATION_UNSPECIFIED => 'RETENTION_DURATION_UNSPECIFIED', self::TWO_MONTHS => 'TWO_MONTHS', self::FOURTEEN_MONTHS => 'FOURTEEN_MONTHS', self::TWENTY_SIX_MONTHS => 'TWENTY_SIX_MONTHS', self::THIRTY_EIGHT_MONTHS => 'THIRTY_EIGHT_MONTHS', self::FIFTY_MONTHS => 'FIFTY_MONTHS'];
...
\class_alias(\Matomo\Dependencies\GoogleAnalyticsImporter\Google\Analytics\Admin\V1alpha\DataRetentionSettings\RetentionDuration::class, \Matomo\Dependencies\GoogleAnalyticsImporter\Google\Analytics\Admin\V1alpha\DataRetentionSettings_RetentionDuration::class);
