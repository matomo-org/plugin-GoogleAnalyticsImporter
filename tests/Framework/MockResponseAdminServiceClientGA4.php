...
class MockResponseAdminServiceClientGA4 extends \Matomo\Dependencies\GoogleAnalyticsImporter\Google\Analytics\Admin\V1alpha\AnalyticsAdminServiceClient
{
    ...
    public function __construct(array $options = [])
    {
        ...
        $options['transport'] = \Piwik\Plugins\GoogleAnalyticsImporter\tests\Framework\MockRestTransport::build($clientOptions['apiEndpoint'], $clientOptions['transportConfig']['rest']['restClientConfigPath'], $clientOptions['transportConfig']['rest']);
