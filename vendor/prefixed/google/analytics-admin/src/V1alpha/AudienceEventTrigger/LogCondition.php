...
class_alias(\Google\Analytics\Admin\V1alpha\AudienceEventTrigger\LogCondition::class, \Google\Analytics\Admin\V1alpha\AudienceEventTrigger_LogCondition::class);
