 ...
 */
namespace Matomo\Dependencies\GoogleAnalyticsImporter\phpseclib3\Crypt\Common;
...
use Matomo\Dependencies\GoogleAnalyticsImporter\phpseclib3\Exception\UnsupportedFormatException;
...
abstract class AsymmetricKey
{
    ...
    public static function load($key, $password = \false)
    {
        ...
        $new->format = $format;
        $new->comment = $comment;
        return $new instanceof \Matomo\Dependencies\GoogleAnalyticsImporter\phpseclib3\Crypt\Common\PrivateKey ? $new->withPassword($password) : $new;
    }
    /**
     * Loads a private key
     *
    ...
    public static function loadPrivateKey($key, $password = '')
    {
        ...
        if (!$key instanceof \Matomo\Dependencies\GoogleAnalyticsImporter\phpseclib3\Crypt\Common\PrivateKey) {
    ...
    {
        $key = self::load($key);
        if (!$key instanceof \Matomo\Dependencies\GoogleAnalyticsImporter\phpseclib3\Crypt\Common\PublicKey) {
    ...
    {
        $key = self::load($key);
        if (!$key instanceof \Matomo\Dependencies\GoogleAnalyticsImporter\phpseclib3\Crypt\Common\PrivateKey && !$key instanceof \Matomo\Dependencies\GoogleAnalyticsImporter\phpseclib3\Crypt\Common\PublicKey) {
