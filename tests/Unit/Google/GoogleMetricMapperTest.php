...
class GoogleMetricMapperTest extends \PHPUnit\Framework\TestCase
{
    ...
    {
        $metricMapper = new GoogleMetricMapper($isEcommerceEnabled = true, $goalsMapping = [
            1 => 3,
            2 => 4,
        ]);
    ...
    public function test_getMappedMetrics_shouldReturnMappedMetricsForMetricIndices()
    {
        ...
        $metrics = $metricMapper->getMappedMetrics([
            Metrics::INDEX_NB_UNIQ_VISITORS,
            Metrics::INDEX_SUM_VISIT_LENGTH,
            Metrics::INDEX_NB_VISITS_CONVERTED,
            Metrics::INDEX_GOALS,
    ...
    public function test_getMappedMetrics_usesCustomMetricMappingsIfSet()
    {
        ...
        $metricMapper->setCustomMappings([
            Metrics::INDEX_NB_UNIQ_VISITORS => 'ga:someMetric',
            Metrics::INDEX_SUM_VISIT_LENGTH => 'ga:someOtherMetric',
        ]);
