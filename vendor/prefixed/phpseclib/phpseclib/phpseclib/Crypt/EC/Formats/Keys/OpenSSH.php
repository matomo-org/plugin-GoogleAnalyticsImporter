...
use Matomo\Dependencies\GoogleAnalyticsImporter\phpseclib3\Crypt\Common\Formats\Keys\OpenSSH as Progenitor;
    ...
    public static function load($key, $password = '')
    {
        ...
        if (isset($parsed['paddedKey'])) {
            ...
            if ($type == 'ssh-ed25519') {
                ...
                $key = \Matomo\Dependencies\GoogleAnalyticsImporter\phpseclib3\Crypt\EC\Formats\Keys\libsodium::load($key);
                $key['comment'] = $comment;
                return $key;
            }
