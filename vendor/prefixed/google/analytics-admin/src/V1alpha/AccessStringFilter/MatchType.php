...
namespace Google\Analytics\Admin\V1alpha\AccessStringFilter;
...
class_alias(\Google\Analytics\Admin\V1alpha\AccessStringFilter\MatchType::class, \Google\Analytics\Admin\V1alpha\AccessStringFilter_MatchType::class);
