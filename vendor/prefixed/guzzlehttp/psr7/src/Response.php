...
class Response implements ResponseInterface
{
    ...
    public function withStatus($code, $reasonPhrase = '') : ResponseInterface
    {
        if (!\is_int($code) && \filter_var($code, \FILTER_VALIDATE_INT) !== \false) {
            \Matomo\Dependencies\GoogleAnalyticsImporter\trigger_deprecation('guzzlehttp/psr7', '2.11', 'Passing %s to ResponseInterface::withStatus() is deprecated; guzzlehttp/psr7 3.0 requires int for $code.', \get_debug_type($code));
        }
        if (!\is_string($reasonPhrase)) {
            \Matomo\Dependencies\GoogleAnalyticsImporter\trigger_deprecation('guzzlehttp/psr7', '2.11', 'Passing %s to ResponseInterface::withStatus() is deprecated; guzzlehttp/psr7 3.0 requires string for $reasonPhrase.', \get_debug_type($reasonPhrase));
        }
