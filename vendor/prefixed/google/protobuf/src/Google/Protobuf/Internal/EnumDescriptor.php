...
use Matomo\Dependencies\GoogleAnalyticsImporter\Google\Protobuf\EnumValueDescriptor;
class EnumDescriptor
{
    ...
    {
        $this->public_desc = new \Matomo\Dependencies\GoogleAnalyticsImporter\Google\Protobuf\EnumDescriptor($this);
    }
    ...
    {
        $desc = new \Matomo\Dependencies\GoogleAnalyticsImporter\Google\Protobuf\Internal\EnumDescriptor();
        $enum_name_without_package = "";
        $classname = "";
        $legacy_classname = "";
        $fullname = "";
        \Matomo\Dependencies\GoogleAnalyticsImporter\Google\Protobuf\Internal\GPBUtil::getFullClassName($proto, $containing, $file_proto, $enum_name_without_package, $classname, $legacy_classname, $fullname);
