...
namespace Matomo\Dependencies\GoogleAnalyticsImporter\Google\Analytics\Admin\V1beta\DataStream;
...
class DataStreamType
{
    ...
    private static $valueToName = [self::DATA_STREAM_TYPE_UNSPECIFIED => 'DATA_STREAM_TYPE_UNSPECIFIED', self::WEB_DATA_STREAM => 'WEB_DATA_STREAM', self::ANDROID_APP_DATA_STREAM => 'ANDROID_APP_DATA_STREAM', self::IOS_APP_DATA_STREAM => 'IOS_APP_DATA_STREAM'];
...
class_alias(DataStreamType::class, \Matomo\Dependencies\GoogleAnalyticsImporter\Google\Analytics\Admin\V1beta\DataStream_DataStreamType::class);
