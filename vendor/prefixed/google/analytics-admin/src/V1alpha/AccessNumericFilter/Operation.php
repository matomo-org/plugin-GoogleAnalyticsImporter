...
namespace Matomo\Dependencies\GoogleAnalyticsImporter\Google\Analytics\Admin\V1alpha\AccessNumericFilter;

use UnexpectedValueException;
/**
 * The operation applied to a numeric filter.
 *
 * Protobuf type <code>google.analytics.admin.v1alpha.AccessNumericFilter.Operation</code>
 */
class Operation
{
    /**
...
class_alias(Operation::class, \Matomo\Dependencies\GoogleAnalyticsImporter\Google\Analytics\Admin\V1alpha\AccessNumericFilter_Operation::class);
