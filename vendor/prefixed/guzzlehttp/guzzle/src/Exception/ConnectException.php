 ...
 */
class ConnectException extends \Matomo\Dependencies\GoogleAnalyticsImporter\GuzzleHttp\Exception\TransferException implements NetworkExceptionInterface
{
    /**
