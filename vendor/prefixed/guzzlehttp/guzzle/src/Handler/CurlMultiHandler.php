...
class CurlMultiHandler
{
    ...
    {
        $this->factory = $options['handle_factory'] ?? new \Matomo\Dependencies\GoogleAnalyticsImporter\GuzzleHttp\Handler\CurlFactory(50);
    ...
    private function processMessages() : void
    {
        while ($done = \curl_multi_info_read($this->_mh)) {
            ...
            $entry['deferred']->resolve(\Matomo\Dependencies\GoogleAnalyticsImporter\GuzzleHttp\Handler\CurlFactory::finish($this, $entry['easy'], $this->factory));
        }
    }
