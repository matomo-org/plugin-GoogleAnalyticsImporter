...
namespace Matomo\Dependencies\GoogleAnalyticsImporter\Google\Analytics\Admin\V1alpha\AudienceEventTrigger;
...
class LogCondition
{
    ...
    private static $valueToName = [self::LOG_CONDITION_UNSPECIFIED => 'LOG_CONDITION_UNSPECIFIED', self::AUDIENCE_JOINED => 'AUDIENCE_JOINED', self::AUDIENCE_MEMBERSHIP_RENEWED => 'AUDIENCE_MEMBERSHIP_RENEWED'];
...
class_alias(LogCondition::class, \Matomo\Dependencies\GoogleAnalyticsImporter\Google\Analytics\Admin\V1alpha\AudienceEventTrigger_LogCondition::class);
