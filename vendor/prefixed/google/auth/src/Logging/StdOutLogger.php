...
use Matomo\Dependencies\GoogleAnalyticsImporter\Psr\Log\LoggerTrait;
use Matomo\Dependencies\GoogleAnalyticsImporter\Psr\Log\LogLevel;
use Stringable;
/**
...
class StdOutLogger implements LoggerInterface
{
     ...
     */
    private $levelMapping = [LogLevel::EMERGENCY => 7, LogLevel::ALERT => 6, LogLevel::CRITICAL => 5, LogLevel::ERROR => 4, LogLevel::WARNING => 3, LogLevel::NOTICE => 2, LogLevel::INFO => 1, LogLevel::DEBUG => 0];
    /**
     * @var int
     */
    private $level;
