...
final class PumpStream implements StreamInterface
{
    ...
    public function __construct(callable $source, array $options = [])
    {
        ...
        $this->buffer = new \Matomo\Dependencies\GoogleAnalyticsImporter\GuzzleHttp\Psr7\BufferStream();
    }
    public function __toString() : string
    {
        try {
            return \Matomo\Dependencies\GoogleAnalyticsImporter\GuzzleHttp\Psr7\Utils::copyToString($this);
        } catch (\Throwable $e) {
