...
class_alias(\Google\Service\Analytics\Resource\ManagementUploads::class, 'Matomo\\Dependencies\\GoogleAnalyticsImporter\\Google_Service_Analytics_Resource_ManagementUploads');
