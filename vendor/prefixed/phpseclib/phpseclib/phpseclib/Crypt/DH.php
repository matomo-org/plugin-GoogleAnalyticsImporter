...
use Matomo\Dependencies\GoogleAnalyticsImporter\phpseclib3\Crypt\DH\Parameters;
use Matomo\Dependencies\GoogleAnalyticsImporter\phpseclib3\Crypt\DH\PrivateKey;
use Matomo\Dependencies\GoogleAnalyticsImporter\phpseclib3\Crypt\DH\PublicKey;
use Matomo\Dependencies\GoogleAnalyticsImporter\phpseclib3\Exception\NoKeyLoadedException;
...
abstract class DH extends AsymmetricKey
{
    ...
    public static function computeSecret($private, $public)
    {
        ...
        if ($private instanceof \Matomo\Dependencies\GoogleAnalyticsImporter\phpseclib3\Crypt\EC\PrivateKey) {
            switch (\true) {
                case $public instanceof \Matomo\Dependencies\GoogleAnalyticsImporter\phpseclib3\Crypt\EC\PublicKey:
    ...
    {
        try {
            return \Matomo\Dependencies\GoogleAnalyticsImporter\phpseclib3\Crypt\EC::load($key, $password);
