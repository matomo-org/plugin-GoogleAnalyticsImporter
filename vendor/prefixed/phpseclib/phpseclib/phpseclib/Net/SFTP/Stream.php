 ...
 */
namespace Matomo\Dependencies\GoogleAnalyticsImporter\phpseclib3\Net\SFTP;

use Matomo\Dependencies\GoogleAnalyticsImporter\phpseclib3\Crypt\Common\PrivateKey;
use Matomo\Dependencies\GoogleAnalyticsImporter\phpseclib3\Net\SFTP;
use Matomo\Dependencies\GoogleAnalyticsImporter\phpseclib3\Net\SSH2;
/**
 * SFTP Stream Wrapper
 *
 * @author  Jim Wigginton <terrafrost@php.net>
...
class Stream
{
    ...
    {
        if (defined('Matomo\\Dependencies\\GoogleAnalyticsImporter\\NET_SFTP_STREAM_LOGGING')) {
            echo "__construct()\r\n";
        }
    }
    /**
