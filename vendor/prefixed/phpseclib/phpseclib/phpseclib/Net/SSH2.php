 ...
 */
namespace Matomo\Dependencies\GoogleAnalyticsImporter\phpseclib3\Net;

use Matomo\Dependencies\GoogleAnalyticsImporter\phpseclib3\Common\Functions\Strings;
use Matomo\Dependencies\GoogleAnalyticsImporter\phpseclib3\Crypt\Blowfish;
use Matomo\Dependencies\GoogleAnalyticsImporter\phpseclib3\Crypt\ChaCha20;
use Matomo\Dependencies\GoogleAnalyticsImporter\phpseclib3\Crypt\Common\AsymmetricKey;
...
use Matomo\Dependencies\GoogleAnalyticsImporter\phpseclib3\Crypt\Common\SymmetricKey;
use Matomo\Dependencies\GoogleAnalyticsImporter\phpseclib3\Crypt\DH;
...
use Matomo\Dependencies\GoogleAnalyticsImporter\phpseclib3\Crypt\RC4;
use Matomo\Dependencies\GoogleAnalyticsImporter\phpseclib3\Crypt\Rijndael;
use Matomo\Dependencies\GoogleAnalyticsImporter\phpseclib3\Crypt\RSA;
use Matomo\Dependencies\GoogleAnalyticsImporter\phpseclib3\Crypt\TripleDES;
// Used to do Diffie-Hellman key exchange and DSA/RSA signature verification.
use Matomo\Dependencies\GoogleAnalyticsImporter\phpseclib3\Crypt\Twofish;
use Matomo\Dependencies\GoogleAnalyticsImporter\phpseclib3\Exception\ConnectionClosedException;
use Matomo\Dependencies\GoogleAnalyticsImporter\phpseclib3\Exception\InsufficientSetupException;
use Matomo\Dependencies\GoogleAnalyticsImporter\phpseclib3\Exception\NoSupportedAlgorithmsException;
use Matomo\Dependencies\GoogleAnalyticsImporter\phpseclib3\Exception\UnableToConnectException;
use Matomo\Dependencies\GoogleAnalyticsImporter\phpseclib3\Exception\UnsupportedAlgorithmException;
use Matomo\Dependencies\GoogleAnalyticsImporter\phpseclib3\Exception\UnsupportedCurveException;
use Matomo\Dependencies\GoogleAnalyticsImporter\phpseclib3\Math\BigInteger;
use Matomo\Dependencies\GoogleAnalyticsImporter\phpseclib3\System\SSH\Agent;
/**
 * Pure-PHP implementation of SSHv2.
 *
 * @package SSH2
...
class SSH2
{
    ...
    private function connect()
    {
        ...
        $extra = $matches[1];
        if (\defined('Matomo\\Dependencies\\GoogleAnalyticsImporter\\NET_SSH2_LOGGING')) {
    ...
    private function key_exchange($kexinit_payload_server = \false)
    {
        ...
        $send_kex = \true;
        $kex_algorithms = isset($preferred['kex']) ? $preferred['kex'] : \Matomo\Dependencies\GoogleAnalyticsImporter\phpseclib3\Net\SSH2::getSupportedKEXAlgorithms();
        $server_host_key_algorithms = isset($preferred['hostkey']) ? $preferred['hostkey'] : \Matomo\Dependencies\GoogleAnalyticsImporter\phpseclib3\Net\SSH2::getSupportedHostKeyAlgorithms();
        $s2c_encryption_algorithms = isset($preferred['server_to_client']['crypt']) ? $preferred['server_to_client']['crypt'] : \Matomo\Dependencies\GoogleAnalyticsImporter\phpseclib3\Net\SSH2::getSupportedEncryptionAlgorithms();
        $c2s_encryption_algorithms = isset($preferred['client_to_server']['crypt']) ? $preferred['client_to_server']['crypt'] : \Matomo\Dependencies\GoogleAnalyticsImporter\phpseclib3\Net\SSH2::getSupportedEncryptionAlgorithms();
        $s2c_mac_algorithms = isset($preferred['server_to_client']['mac']) ? $preferred['server_to_client']['mac'] : \Matomo\Dependencies\GoogleAnalyticsImporter\phpseclib3\Net\SSH2::getSupportedMACAlgorithms();
        $c2s_mac_algorithms = isset($preferred['client_to_server']['mac']) ? $preferred['client_to_server']['mac'] : \Matomo\Dependencies\GoogleAnalyticsImporter\phpseclib3\Net\SSH2::getSupportedMACAlgorithms();
        $s2c_compression_algorithms = isset($preferred['server_to_client']['comp']) ? $preferred['server_to_client']['comp'] : \Matomo\Dependencies\GoogleAnalyticsImporter\phpseclib3\Net\SSH2::getSupportedCompressionAlgorithms();
        $c2s_compression_algorithms = isset($preferred['client_to_server']['comp']) ? $preferred['client_to_server']['comp'] : \Matomo\Dependencies\GoogleAnalyticsImporter\phpseclib3\Net\SSH2::getSupportedCompressionAlgorithms();
    ...
    private function read_remaining_bytes($remaining_length)
    {
        ...
        if ($remaining_length < -$this->decrypt_block_size || $remaining_length > 0x9000 || $remaining_length % $this->decrypt_block_size != 0) {
            if (!$this->bad_key_size_fix && self::bad_algorithm_candidate($this->decrypt ? $this->decryptName : '') && !($this->bitmap & \Matomo\Dependencies\GoogleAnalyticsImporter\phpseclib3\Net\SSH2::MASK_LOGIN)) {
    ...
    {
        if (\defined('Matomo\\Dependencies\\GoogleAnalyticsImporter\\NET_SSH2_LOGGING') && NET_SSH2_LOGGING == self::LOG_COMPLEX) {
