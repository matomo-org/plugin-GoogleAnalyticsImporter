...
class ReportRequest extends \Matomo\Dependencies\GoogleAnalyticsImporter\Google\Collection
{
    ...
    protected $cohortGroupType = \Matomo\Dependencies\GoogleAnalyticsImporter\Google\Service\AnalyticsReporting\CohortGroup::class;
    protected $cohortGroupDataType = '';
    protected $dateRangesType = \Matomo\Dependencies\GoogleAnalyticsImporter\Google\Service\AnalyticsReporting\DateRange::class;
    protected $dateRangesDataType = 'array';
    protected $dimensionFilterClausesType = \Matomo\Dependencies\GoogleAnalyticsImporter\Google\Service\AnalyticsReporting\DimensionFilterClause::class;
    protected $dimensionFilterClausesDataType = 'array';
    protected $dimensionsType = \Matomo\Dependencies\GoogleAnalyticsImporter\Google\Service\AnalyticsReporting\Dimension::class;
    protected $dimensionsDataType = 'array';
    public $filtersExpression;
    public $hideTotals;
    public $hideValueRanges;
    public $includeEmptyRows;
    protected $metricFilterClausesType = \Matomo\Dependencies\GoogleAnalyticsImporter\Google\Service\AnalyticsReporting\MetricFilterClause::class;
    protected $metricFilterClausesDataType = 'array';
    protected $metricsType = \Matomo\Dependencies\GoogleAnalyticsImporter\Google\Service\AnalyticsReporting\Metric::class;
    protected $metricsDataType = 'array';
    protected $orderBysType = \Matomo\Dependencies\GoogleAnalyticsImporter\Google\Service\AnalyticsReporting\OrderBy::class;
    protected $orderBysDataType = 'array';
    public $pageSize;
    public $pageToken;
    protected $pivotsType = \Matomo\Dependencies\GoogleAnalyticsImporter\Google\Service\AnalyticsReporting\Pivot::class;
    protected $pivotsDataType = 'array';
    public $samplingLevel;
    protected $segmentsType = \Matomo\Dependencies\GoogleAnalyticsImporter\Google\Service\AnalyticsReporting\Segment::class;
    protected $segmentsDataType = 'array';
    public $viewId;
    /**
     * @param CohortGroup
     */
    public function setCohortGroup(\Matomo\Dependencies\GoogleAnalyticsImporter\Google\Service\AnalyticsReporting\CohortGroup $cohortGroup)
    {
...
\class_alias(\Matomo\Dependencies\GoogleAnalyticsImporter\Google\Service\AnalyticsReporting\ReportRequest::class, 'Matomo\\Dependencies\\GoogleAnalyticsImporter\\Google_Service_AnalyticsReporting_ReportRequest');
