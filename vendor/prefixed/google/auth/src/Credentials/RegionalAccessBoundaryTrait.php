...
use Matomo\Dependencies\GoogleAnalyticsImporter\Psr\Http\Client\NetworkExceptionInterface;
/**
...
trait RegionalAccessBoundaryTrait
{
     ...
     * @var bool
     */
    private $enableRegionalAccessBoundary = \false;
    /**
     * @param array<mixed> $headers
     * @return null|array{locations: array<string>, encodedLocations: string}
     */
    private function getRegionalAccessBoundary(string $universeDomain, callable $httpHandler, string $regionalAccessBoundaryUrl, array $headers)
    {
     ...
     * @return null|array{locations: array<string>, encodedLocations: string}
     */
    private function lookupRegionalAccessBoundary(callable $httpHandler, string $regionalAccessBoundaryUrl, array $authHeader)
    {
