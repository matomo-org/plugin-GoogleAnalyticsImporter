 ...
 */
namespace Matomo\Dependencies\GoogleAnalyticsImporter\phpseclib3\Math;

use Matomo\Dependencies\GoogleAnalyticsImporter\phpseclib3\Exception\BadConfigurationException;
use Matomo\Dependencies\GoogleAnalyticsImporter\phpseclib3\Math\BigInteger\Engines\Engine;
/**
...
class BigInteger implements \JsonSerializable
{
    ...
    public function __construct($x = 0, $base = 10)
    {
        ...
        if ($x instanceof self::$mainEngine) {
            $this->value = clone $x;
        } elseif ($x instanceof \Matomo\Dependencies\GoogleAnalyticsImporter\phpseclib3\Math\BigInteger\Engines\Engine) {
     ...
     * @return BigInteger
     */
    public function add(\Matomo\Dependencies\GoogleAnalyticsImporter\phpseclib3\Math\BigInteger $y)
    {
     ...
     * @return BigInteger
     */
    public function subtract(\Matomo\Dependencies\GoogleAnalyticsImporter\phpseclib3\Math\BigInteger $y)
    {
     ...
     * @return BigInteger
     */
    public function multiply(\Matomo\Dependencies\GoogleAnalyticsImporter\phpseclib3\Math\BigInteger $x)
    {
     ...
     * @return BigInteger[]
     */
    public function divide(\Matomo\Dependencies\GoogleAnalyticsImporter\phpseclib3\Math\BigInteger $y)
    {
     ...
     * @return BigInteger
     */
    public function modInverse(\Matomo\Dependencies\GoogleAnalyticsImporter\phpseclib3\Math\BigInteger $n)
    {
     ...
     * @return BigInteger[]
     */
    public function extendedGCD(\Matomo\Dependencies\GoogleAnalyticsImporter\phpseclib3\Math\BigInteger $n)
    {
     ...
     * @return BigInteger
     */
    public function gcd(\Matomo\Dependencies\GoogleAnalyticsImporter\phpseclib3\Math\BigInteger $n)
    {
     ...
     * @return BigInteger
     */
    public function powMod(\Matomo\Dependencies\GoogleAnalyticsImporter\phpseclib3\Math\BigInteger $e, \Matomo\Dependencies\GoogleAnalyticsImporter\phpseclib3\Math\BigInteger $n)
    {
     ...
     * @return BigInteger
     */
    public function modPow(\Matomo\Dependencies\GoogleAnalyticsImporter\phpseclib3\Math\BigInteger $e, \Matomo\Dependencies\GoogleAnalyticsImporter\phpseclib3\Math\BigInteger $n)
    {
     ...
     * @see self::equals()
     */
    public function compare(\Matomo\Dependencies\GoogleAnalyticsImporter\phpseclib3\Math\BigInteger $y)
    {
     ...
     * @return bool
     */
    public function equals(\Matomo\Dependencies\GoogleAnalyticsImporter\phpseclib3\Math\BigInteger $x)
    {
     ...
     * @return BigInteger
     */
    public function bitwise_and(\Matomo\Dependencies\GoogleAnalyticsImporter\phpseclib3\Math\BigInteger $x)
    {
     ...
     * @return BigInteger
     */
    public function bitwise_or(\Matomo\Dependencies\GoogleAnalyticsImporter\phpseclib3\Math\BigInteger $x)
    {
     ...
     * @return BigInteger
     */
    public function bitwise_xor(\Matomo\Dependencies\GoogleAnalyticsImporter\phpseclib3\Math\BigInteger $x)
    {
     ...
     */
    public static function randomRangePrime(\Matomo\Dependencies\GoogleAnalyticsImporter\phpseclib3\Math\BigInteger $min, \Matomo\Dependencies\GoogleAnalyticsImporter\phpseclib3\Math\BigInteger $max)
    {
        $class = self::$mainEngine;
     ...
     * @return BigInteger
     */
    public static function randomRange(\Matomo\Dependencies\GoogleAnalyticsImporter\phpseclib3\Math\BigInteger $min, \Matomo\Dependencies\GoogleAnalyticsImporter\phpseclib3\Math\BigInteger $max)
    {
        $class = self::$mainEngine;
     ...
     * @return BigInteger
     */
    public function pow(\Matomo\Dependencies\GoogleAnalyticsImporter\phpseclib3\Math\BigInteger $n)
    {
     ...
     * @return BigInteger
     */
    public static function min(\Matomo\Dependencies\GoogleAnalyticsImporter\phpseclib3\Math\BigInteger ...$nums)
    {
        $class = self::$mainEngine;
     ...
     * @return BigInteger
     */
    public static function max(\Matomo\Dependencies\GoogleAnalyticsImporter\phpseclib3\Math\BigInteger ...$nums)
    {
        $class = self::$mainEngine;
        $nums = \array_map(function ($num) {
            return $num->value;
     ...
     * @return bool
     */
    public function between(\Matomo\Dependencies\GoogleAnalyticsImporter\phpseclib3\Math\BigInteger $min, \Matomo\Dependencies\GoogleAnalyticsImporter\phpseclib3\Math\BigInteger $max)
    {
     ...
     * @return int
     */
    public static function scan1divide(\Matomo\Dependencies\GoogleAnalyticsImporter\phpseclib3\Math\BigInteger $r)
    {
        $class = self::$mainEngine;
    ...
    public function createRecurringModuloFunction()
    {
        ...
        return function (\Matomo\Dependencies\GoogleAnalyticsImporter\phpseclib3\Math\BigInteger $x) use($func) {
