 ...
 *
 * Protobuf type <code>google.analytics.admin.v1beta.ActionType</code>
 */
class ActionType
{
    /**
     ...
     */
    const DELETED = 3;
    private static $valueToName = [self::ACTION_TYPE_UNSPECIFIED => 'ACTION_TYPE_UNSPECIFIED', self::CREATED => 'CREATED', self::UPDATED => 'UPDATED', self::DELETED => 'DELETED'];
