...
class_alias(\Google\Analytics\Admin\V1alpha\Audience\AudienceExclusionDurationMode::class, \Google\Analytics\Admin\V1alpha\Audience_AudienceExclusionDurationMode::class);
