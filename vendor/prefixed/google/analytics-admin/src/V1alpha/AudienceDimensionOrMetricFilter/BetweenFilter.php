...
class_alias(\Google\Analytics\Admin\V1alpha\AudienceDimensionOrMetricFilter\BetweenFilter::class, \Google\Analytics\Admin\V1alpha\AudienceDimensionOrMetricFilter_BetweenFilter::class);
