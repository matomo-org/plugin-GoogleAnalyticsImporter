...
class_alias(AnalyticsDataimportDeleteUploadDataRequest::class, 'Matomo\\Dependencies\\GoogleAnalyticsImporter\\Google_Service_Analytics_AnalyticsDataimportDeleteUploadDataRequest');
