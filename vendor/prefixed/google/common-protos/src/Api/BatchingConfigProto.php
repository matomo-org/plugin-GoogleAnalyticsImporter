 ...
 */
class BatchingConfigProto extends \Matomo\Dependencies\GoogleAnalyticsImporter\Google\Protobuf\Internal\Message
{
    /**
    ...
    {
        GPBUtil::checkMessage($var, \Matomo\Dependencies\GoogleAnalyticsImporter\Google\Api\BatchingSettingsProto::class);
        $this->thresholds = $var;
        return $this;
    }
    /**
    ...
    {
        GPBUtil::checkMessage($var, \Matomo\Dependencies\GoogleAnalyticsImporter\Google\Api\BatchingDescriptorProto::class);
