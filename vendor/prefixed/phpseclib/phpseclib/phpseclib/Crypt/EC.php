...
abstract class EC extends AsymmetricKey
{
    ...
    public static function createKey($curve)
    {
        ...
        if (self::$engines['libsodium'] && $curve == 'ed25519' && \function_exists('sodium_crypto_sign_keypair')) {
            ...
            $privatekey = \Matomo\Dependencies\GoogleAnalyticsImporter\phpseclib3\Crypt\EC::loadFormat('libsodium', \sodium_crypto_sign_secretkey($kp));
    ...
    public function getParameters($type = 'PKCS1')
    {
        ...
        return \Matomo\Dependencies\GoogleAnalyticsImporter\phpseclib3\Crypt\EC::load($key, 'PKCS1')->withHash($this->hash->getHash())->withSignatureFormat($this->shortFormat);
    }
    /**
