    ...
    public function getApiTestsToRun()
    {
        ...
        return [
            ...
            [['Goals.getDaysToConversion', 'Goals.getVisitsUntilConversion'], [
                ...
                'testSuffix' => '_GA4_ecommerceOrder',
            ]],
            ...
            ['CustomDimensions.getCustomDimension', [
                ...
                'date' => self::$fixture->dateTime,
                'periods' => ['day', 'week', 'month', 'year'],
                'testSuffix' => '_GA4_extraCustomDim',
                'otherRequestParameters' => [
            ...
            ['VisitsSummary.get', [
                ...
                'date' => '2019-07-03',
                'periods' => 'week',
                'testSuffix' => '_GA4_aggregatedWithTrackedVisit',
            ]],
        ];
    }
...
ImportTestGA4::$fixture = new ImportedFromGoogleGA4();