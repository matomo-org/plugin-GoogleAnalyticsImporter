 ...
 * @experimental
 */
namespace Matomo\Dependencies\GoogleAnalyticsImporter\Google\Analytics\Data\V1alpha\Gapic;

use Matomo\Dependencies\GoogleAnalyticsImporter\Google\Analytics\Data\V1alpha\BatchRunPivotReportsRequest;
use Matomo\Dependencies\GoogleAnalyticsImporter\Google\Analytics\Data\V1alpha\BatchRunPivotReportsResponse;
use Matomo\Dependencies\GoogleAnalyticsImporter\Google\Analytics\Data\V1alpha\BatchRunReportsRequest;
use Matomo\Dependencies\GoogleAnalyticsImporter\Google\Analytics\Data\V1alpha\BatchRunReportsResponse;
use Matomo\Dependencies\GoogleAnalyticsImporter\Google\Analytics\Data\V1alpha\CohortSpec;
use Matomo\Dependencies\GoogleAnalyticsImporter\Google\Analytics\Data\V1alpha\DateRange;
use Matomo\Dependencies\GoogleAnalyticsImporter\Google\Analytics\Data\V1alpha\Dimension;
use Matomo\Dependencies\GoogleAnalyticsImporter\Google\Analytics\Data\V1alpha\Entity;
use Matomo\Dependencies\GoogleAnalyticsImporter\Google\Analytics\Data\V1alpha\FilterExpression;
use Matomo\Dependencies\GoogleAnalyticsImporter\Google\Analytics\Data\V1alpha\GetMetadataRequest;
use Matomo\Dependencies\GoogleAnalyticsImporter\Google\Analytics\Data\V1alpha\Metadata;
use Matomo\Dependencies\GoogleAnalyticsImporter\Google\Analytics\Data\V1alpha\Metric;
use Matomo\Dependencies\GoogleAnalyticsImporter\Google\Analytics\Data\V1alpha\MetricAggregation;
use Matomo\Dependencies\GoogleAnalyticsImporter\Google\Analytics\Data\V1alpha\OrderBy;
use Matomo\Dependencies\GoogleAnalyticsImporter\Google\Analytics\Data\V1alpha\Pivot;
use Matomo\Dependencies\GoogleAnalyticsImporter\Google\Analytics\Data\V1alpha\RunPivotReportRequest;
use Matomo\Dependencies\GoogleAnalyticsImporter\Google\Analytics\Data\V1alpha\RunPivotReportResponse;
use Matomo\Dependencies\GoogleAnalyticsImporter\Google\Analytics\Data\V1alpha\RunRealtimeReportRequest;
use Matomo\Dependencies\GoogleAnalyticsImporter\Google\Analytics\Data\V1alpha\RunRealtimeReportResponse;
use Matomo\Dependencies\GoogleAnalyticsImporter\Google\Analytics\Data\V1alpha\RunReportRequest;
use Matomo\Dependencies\GoogleAnalyticsImporter\Google\Analytics\Data\V1alpha\RunReportResponse;
...
class AlphaAnalyticsDataGapicClient
{
    ...
    private static function getPathTemplateMap()
    {
        if (self::$pathTemplateMap == null) {
            self::$pathTemplateMap = ['metadata' => self::getMetadataNameTemplate()];
        }
