...
class_alias(\Google\Analytics\Admin\V1alpha\ExpandedDataSetFilter\StringFilter::class, \Google\Analytics\Admin\V1alpha\ExpandedDataSetFilter_StringFilter::class);
