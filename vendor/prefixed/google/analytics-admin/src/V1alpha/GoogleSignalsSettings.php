 ...
 */
class GoogleSignalsSettings extends \Matomo\Dependencies\GoogleAnalyticsImporter\Google\Protobuf\Internal\Message
{
    /**
    ...
    {
        GPBUtil::checkEnum($var, \Matomo\Dependencies\GoogleAnalyticsImporter\Google\Analytics\Admin\V1alpha\GoogleSignalsState::class);
        $this->state = $var;
        return $this;
    }
    /**
    ...
    {
        GPBUtil::checkEnum($var, \Matomo\Dependencies\GoogleAnalyticsImporter\Google\Analytics\Admin\V1alpha\GoogleSignalsConsent::class);
        $this->consent = $var;
        return $this;
    }
}
