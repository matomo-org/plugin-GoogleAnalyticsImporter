...
class_alias(\Google\Analytics\Admin\V1alpha\AudienceDimensionOrMetricFilter\InListFilter::class, \Google\Analytics\Admin\V1alpha\AudienceDimensionOrMetricFilter_InListFilter::class);
