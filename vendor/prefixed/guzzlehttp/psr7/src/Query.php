...
final class Query
{
    ...
    private static function normalizeNonFiniteFloat($value)
    {
        if (is_float($value) && !is_finite($value)) {
            \Matomo\Dependencies\GoogleAnalyticsImporter\trigger_deprecation('guzzlehttp/psr7', '2.12', 'Passing a non-finite float to Query::build() is deprecated; guzzlehttp/psr7 3.0 rejects non-finite floats.');
