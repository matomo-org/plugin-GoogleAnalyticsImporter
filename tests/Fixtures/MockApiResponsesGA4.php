...
class MockApiResponsesGA4 extends Fixture
{
    ...
    public function setUp(): void
    {
        ...
        Option::set(AuthorizationGA4::CLIENT_CONFIG_OPTION_NAME, json_encode([
            'web' => [
    ...
    {
        return [
            'GoogleAnalyticsImporter.googleAnalyticsDataClientClass' => MockResponseClientGA4::class,
            'GoogleAnalyticsImporter.googleAnalyticsAdminServiceClientClass' => MockResponseAdminServiceClientGA4::class,
        ];
    }
}