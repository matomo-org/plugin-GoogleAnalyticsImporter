...
class SequenceSegment extends \Matomo\Dependencies\GoogleAnalyticsImporter\Google\Collection
{
    ...
    protected $segmentSequenceStepsType = \Google\Service\AnalyticsReporting\SegmentSequenceStep::class;
...
class_alias(\Google\Service\AnalyticsReporting\SequenceSegment::class, 'Matomo\\Dependencies\\GoogleAnalyticsImporter\\Google_Service_AnalyticsReporting_SequenceSegment');
