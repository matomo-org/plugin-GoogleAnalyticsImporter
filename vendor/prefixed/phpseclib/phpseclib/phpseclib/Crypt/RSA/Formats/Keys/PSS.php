 ...
 */
namespace Matomo\Dependencies\GoogleAnalyticsImporter\phpseclib3\Crypt\RSA\Formats\Keys;
...
abstract class PSS extends Progenitor
{
    ...
    public static function load($key, $password = '')
    {
        ...
        $result = $components + \Matomo\Dependencies\GoogleAnalyticsImporter\phpseclib3\Crypt\RSA\Formats\Keys\PKCS1::load($key[$type . 'Key']);
    ...
    {
        self::initialize_static_variables();
        $key = \Matomo\Dependencies\GoogleAnalyticsImporter\phpseclib3\Crypt\RSA\Formats\Keys\PKCS1::savePrivateKey($n, $e, $d, $primes, $exponents, $coefficients);
    ...
    {
        self::initialize_static_variables();
        $key = \Matomo\Dependencies\GoogleAnalyticsImporter\phpseclib3\Crypt\RSA\Formats\Keys\PKCS1::savePublicKey($n, $e);
        $key = ASN1::extractBER($key);
        $params = self::savePSSParams($options);
