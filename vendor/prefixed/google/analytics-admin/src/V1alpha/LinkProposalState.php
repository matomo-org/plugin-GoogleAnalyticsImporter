...
class LinkProposalState
{
     ...
     */
    const OBSOLETE = 6;
    private static $valueToName = [self::LINK_PROPOSAL_STATE_UNSPECIFIED => 'LINK_PROPOSAL_STATE_UNSPECIFIED', self::AWAITING_REVIEW_FROM_GOOGLE_ANALYTICS => 'AWAITING_REVIEW_FROM_GOOGLE_ANALYTICS', self::AWAITING_REVIEW_FROM_LINKED_PRODUCT => 'AWAITING_REVIEW_FROM_LINKED_PRODUCT', self::WITHDRAWN => 'WITHDRAWN', self::DECLINED => 'DECLINED', self::EXPIRED => 'EXPIRED', self::OBSOLETE => 'OBSOLETE'];
