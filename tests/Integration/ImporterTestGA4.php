...
class ImporterTestGA4 extends IntegrationTestCase
{
    ...
    {
        return [
            'GoogleAnalyticsImporter.googleAnalyticsAdminServiceClientClass' => $this->makeMockService(),
        ];
    }
    ...
    private function setGaEntities()
    {
        ...
        $goal1 = new \Google\Analytics\Admin\V1alpha\ConversionEvent([
            'name' => 'properties/12345/conversionEvents/345678910' ,
            'event_name' => 'abc',
            'create_time' => new \Google\Protobuf\Timestamp([
                'seconds' => '10000',
                'nanos' => '999',
            ]),
            'deletable' => true,
        ...
        // custom dimensions
        $customDim1 = new \Google\Analytics\Admin\V1alpha\CustomDimension([
            'name' => 'properties/12345/customDimensions/3456789',
            'parameter_name' => '',
            'display_name' => 'cdim 1',
            'description' => 'cdim 1 desc',
            'scope' => 1
        ]);

        $customDim2 = new \Google\Analytics\Admin\V1alpha\CustomDimension([
            'name' => 'properties/12345/customDimensions/34567891',
            'parameter_name' => '',
            'display_name' => 'cdim 2',
            'description' => 'cdim 2 desc',
            'scope' => 2
        ]);

        $customDim3 = new \Google\Analytics\Admin\V1alpha\CustomDimension([
            'name' => 'properties/12345/customDimensions/34567892',
            'parameter_name' => '',
            'display_name' => 'cdim 3',
            'description' => 'cdim 3 desc',
            'scope' => 1
        ]);
    ...
    private function checkEntitiesCreated($idSite)
    {
        ...
        $this->assertEquals([
            [
                ...
                'idsite' => '1',
                'name' => 'abc',
                'description' => '(imported from Google Analytics(GA4), original id = 345678910)',
...
class MockGoogleServiceAnalytics extends \Google\Analytics\Admin\V1alpha\AnalyticsAdminServiceClient
{
    ...
    {
        $this->test = $test;
        $this->listConversionEvents = new MockGaManagementGoals($test);
        $this->listCustomDimensions = new MockGaCustomDimensions($test);
    }

    public function listConversionEvents($parent, array $optionalArgs = [])
    {
        return new MockGaManagementGoals($this->test);
    }

    public function listCustomDimensions($parent, array $optionalArgs = [])
    {
        return new MockGaCustomDimensions($this->test);
    }
}
