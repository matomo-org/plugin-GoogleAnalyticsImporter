...
namespace Matomo\Dependencies\GoogleAnalyticsImporter\Brick\Math;

use Matomo\Dependencies\GoogleAnalyticsImporter\Brick\Math\Exception\DivisionByZeroException;
use Matomo\Dependencies\GoogleAnalyticsImporter\Brick\Math\Exception\IntegerOverflowException;
use Matomo\Dependencies\GoogleAnalyticsImporter\Brick\Math\Exception\InvalidArgumentException;
...
use Matomo\Dependencies\GoogleAnalyticsImporter\Brick\Math\Internal\Safe;
...
abstract readonly class BigNumber implements JsonSerializable, Stringable
{
     ...
     * @pure
     */
    public static final function of(BigNumber|int|string $value) : static
    {
     ...
     * @pure
     */
    public static final function ofNullable(BigNumber|int|string|null $value) : ?static
    {
        if (is_null($value)) {
            return null;
        }
     ...
     * @pure
     */
    public static final function min(BigNumber|int|string $a, BigNumber|int|string ...$n) : static
    {
        $min = static::of($a);
        foreach ($n as $value) {
     ...
     * @pure
     */
    public static final function max(BigNumber|int|string $a, BigNumber|int|string ...$n) : static
    {
        $max = static::of($a);
        foreach ($n as $value) {
            $value = static::of($value);
     ...
     * @pure
     */
    public static final function sum(BigNumber|int|string $a, BigNumber|int|string ...$n) : static
    {
        $sum = static::of($a);
        foreach ($n as $value) {
     ...
     * @pure
     */
    public final function isEqualTo(BigNumber|int|string $that) : bool
    {
     ...
     * @pure
     */
    public final function isLessThan(BigNumber|int|string $that) : bool
    {
        return $this->compareTo($that) < 0;
    }
    /**
     ...
     * @pure
     */
    public final function isLessThanOrEqualTo(BigNumber|int|string $that) : bool
    {
        return $this->compareTo($that) <= 0;
    }
    /**
     ...
     * @pure
     */
    public final function isGreaterThan(BigNumber|int|string $that) : bool
    {
        return $this->compareTo($that) > 0;
    }
    /**
     ...
     * @pure
     */
    public final function isGreaterThanOrEqualTo(BigNumber|int|string $that) : bool
    {
        return $this->compareTo($that) >= 0;
    }
    /**
     ...
     * @pure
     */
    public abstract function compareTo(BigNumber|int|string $that) : int;
    /**
     ...
     * @pure
     */
    public final function clamp(BigNumber|int|string $min, BigNumber|int|string $max) : static
    {
        $min = static::of($min);
        $max = static::of($max);
     ...
     * @pure
     */
    protected final function newBigRational(BigInteger $numerator, BigInteger $denominator, bool $checkDenominator, bool $simplify) : BigRational
    {
