...
use Matomo\Dependencies\GoogleAnalyticsImporter\GuzzleHttp\Message\ResponseInterface as Guzzle5ResponseInterface;
use Matomo\Dependencies\GoogleAnalyticsImporter\GuzzleHttp\Promise\Promise;
use Matomo\Dependencies\GoogleAnalyticsImporter\GuzzleHttp\Promise\RejectedPromise;
...
class Guzzle5HttpHandler
{
    ...
    {
        if (!class_exists('Matomo\\Dependencies\\GoogleAnalyticsImporter\\GuzzleHttp\\Promise\\Promise')) {
