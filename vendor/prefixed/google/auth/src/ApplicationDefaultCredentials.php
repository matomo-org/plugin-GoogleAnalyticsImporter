...
class ApplicationDefaultCredentials
{
    ...
    {
        $creds = null;
        $jsonKey = \Matomo\Dependencies\GoogleAnalyticsImporter\Google\Auth\CredentialsLoader::fromEnv() ?: \Matomo\Dependencies\GoogleAnalyticsImporter\Google\Auth\CredentialsLoader::fromWellKnownFile();
        ...
        if (!\is_null($jsonKey)) {
            ...
            $creds = \Matomo\Dependencies\GoogleAnalyticsImporter\Google\Auth\CredentialsLoader::makeCredentials($scope, $jsonKey, $defaultScope);
        ...
        if (!\is_null($cache)) {
            $creds = new \Matomo\Dependencies\GoogleAnalyticsImporter\Google\Auth\FetchAuthTokenCache($creds, $cacheConfig, $cache);
        }
        return $creds;
    }
    /**
    ...
    private static function onGce(callable $httpHandler = null, array $cacheConfig = null, CacheItemPoolInterface $cache = null)
    {
        ...
        return (new \Matomo\Dependencies\GoogleAnalyticsImporter\Google\Auth\GCECache($gceCacheConfig, $cache))->onGce($httpHandler);
    }
}
