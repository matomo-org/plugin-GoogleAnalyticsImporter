...
class CachedKeySet implements ArrayAccess
{
     ...
     * @return Key
     */
    public function offsetGet($keyId) : \Matomo\Dependencies\GoogleAnalyticsImporter\Firebase\JWT\Key
    {
    ...
    private function keyIdExists(string $keyId) : bool
    {
        ...
        if (!isset($this->keySet[$keyId])) {
            ...
            $this->keySet = $keySetToCache = \Matomo\Dependencies\GoogleAnalyticsImporter\Firebase\JWT\JWK::parseKeySet($jwks, $this->defaultAlg);
            if (!isset($this->keySet[$keyId])) {
                return \false;
            }
        }
