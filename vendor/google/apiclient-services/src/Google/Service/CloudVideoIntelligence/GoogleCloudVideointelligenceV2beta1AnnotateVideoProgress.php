...
class Google_Service_CloudVideoIntelligence_GoogleCloudVideointelligenceV2beta1AnnotateVideoProgress extends Google_Collection
{
  ...
  /**
   * @return Google_Service_CloudVideoIntelligence_GoogleCloudVideointelligenceV2beta1VideoAnnotationProgress
   */
