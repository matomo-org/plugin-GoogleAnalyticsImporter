...
class Hash
{
    ...
    private function pdf()
    {
        ...
        //
        $kp = $this->kdf(0, 16);
        $c = new \Matomo\Dependencies\GoogleAnalyticsImporter\phpseclib3\Crypt\AES('ctr');
        $c->disablePadding();
        $c->setKey($kp);
        $c->setIV($nonce);
    ...
    public function hash($text)
    {
        ...
        if ($algo == 'umac') {
            if ($this->recomputeAESKey) {
                ...
                $this->c = new \Matomo\Dependencies\GoogleAnalyticsImporter\phpseclib3\Crypt\AES('ctr');
