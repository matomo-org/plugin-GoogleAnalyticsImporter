 ...
 */
namespace Matomo\Dependencies\GoogleAnalyticsImporter\phpseclib3\Crypt\EC\BaseCurves;
...
use Matomo\Dependencies\GoogleAnalyticsImporter\phpseclib3\Math\PrimeField\Integer as PrimeInteger;
/**
 * Curves over y^2 = x^3 + a*x + b
 *
 * @package Prime
 ...
 * @access  public
 */
class Prime extends \Matomo\Dependencies\GoogleAnalyticsImporter\phpseclib3\Crypt\EC\BaseCurves\Base
{
    /**
