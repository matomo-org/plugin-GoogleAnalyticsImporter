...
final class Utils
{
    ...
    private static function triggerNonIterableDeprecation($promises, string $method) : void
    {
        ...
        \Matomo\Dependencies\GoogleAnalyticsImporter\trigger_deprecation('guzzlehttp/promises', '2.5', 'Passing a non-iterable to %s::%s() is deprecated; guzzlehttp/promises 3.0 will require an iterable.', self::class, $method);
    }
}
