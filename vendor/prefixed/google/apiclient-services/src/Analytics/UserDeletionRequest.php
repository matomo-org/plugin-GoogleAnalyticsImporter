...
class UserDeletionRequest extends \Matomo\Dependencies\GoogleAnalyticsImporter\Google\Model
{
    ...
    protected $idType = \Matomo\Dependencies\GoogleAnalyticsImporter\Google\Service\Analytics\UserDeletionRequestId::class;
     ...
     */
    public function setId(\Matomo\Dependencies\GoogleAnalyticsImporter\Google\Service\Analytics\UserDeletionRequestId $id)
    {
        $this->id = $id;
    }
    /**
...
\class_alias(\Matomo\Dependencies\GoogleAnalyticsImporter\Google\Service\Analytics\UserDeletionRequest::class, 'Matomo\\Dependencies\\GoogleAnalyticsImporter\\Google_Service_Analytics_UserDeletionRequest');
