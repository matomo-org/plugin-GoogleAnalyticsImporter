...
use Matomo\Dependencies\GoogleAnalyticsImporter\GuzzleHttp\Handler\HostValidator;
...
class SetCookie
{
    ...
    {
        if (!is_string($name)) {
            \Matomo\Dependencies\GoogleAnalyticsImporter\trigger_deprecation('guzzlehttp/guzzle', '7.4', 'Not passing a string to %s::%s() is deprecated and will cause an error in 8.0.', __CLASS__, __FUNCTION__);
        }
    ...
    public function setDomain($domain) : void
    {
        if (!is_string($domain) && null !== $domain) {
            \Matomo\Dependencies\GoogleAnalyticsImporter\trigger_deprecation('guzzlehttp/guzzle', '7.4', 'Not passing a string or null to %s::%s() is deprecated and will cause an error in 8.0.', __CLASS__, __FUNCTION__);
        }
    ...
    public function setMaxAge($maxAge) : void
    {
        if (!is_int($maxAge) && null !== $maxAge) {
            \Matomo\Dependencies\GoogleAnalyticsImporter\trigger_deprecation('guzzlehttp/guzzle', '7.4', 'Not passing an int or null to %s::%s() is deprecated and will cause an error in 8.0.', __CLASS__, __FUNCTION__);
        }
    ...
    public function setExpires($timestamp) : void
    {
        if (!is_int($timestamp) && !is_string($timestamp) && null !== $timestamp) {
            \Matomo\Dependencies\GoogleAnalyticsImporter\trigger_deprecation('guzzlehttp/guzzle', '7.4', 'Not passing an int, string or null to %s::%s() is deprecated and will cause an error in 8.0.', __CLASS__, __FUNCTION__);
        }
        if (null === $timestamp) {
    ...
    {
        if (!is_bool($secure)) {
            \Matomo\Dependencies\GoogleAnalyticsImporter\trigger_deprecation('guzzlehttp/guzzle', '7.4', 'Not passing a bool to %s::%s() is deprecated and will cause an error in 8.0.', __CLASS__, __FUNCTION__);
        }
    ...
    private static function isIpAddressOrNumericHost(string $host) : bool
    {
        ...
        if ($host !== '' && substr_compare($host, '.', -strlen('.')) === 0) {
